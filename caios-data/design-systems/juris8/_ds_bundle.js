/* @ds-bundle: {"format":3,"namespace":"Juris8DesignSystem_75d483","components":[{"name":"Alert","sourcePath":"components/core/Alert.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Eyebrow","sourcePath":"components/core/Eyebrow.jsx"},{"name":"Input","sourcePath":"components/core/Input.jsx"},{"name":"Select","sourcePath":"components/core/Select.jsx"},{"name":"Stat","sourcePath":"components/core/Stat.jsx"}],"sourceHashes":{"components/core/Alert.jsx":"d8ca26a2620f","components/core/Badge.jsx":"af2895085fdf","components/core/Button.jsx":"33a7f25a932f","components/core/Card.jsx":"1bd7d50e99c4","components/core/Eyebrow.jsx":"a9210af61502","components/core/Input.jsx":"975bc092e622","components/core/Select.jsx":"1cac87fd2149","components/core/Stat.jsx":"3cfc6d57833a","site/mockup9-embed/dist/assets/index-D5YeOlk5.js":"7fd93979e90b","ui_kits/det-monitor/CertConfig.jsx":"612d145ff346","ui_kits/det-monitor/Dashboard.jsx":"3a7d172ea850","ui_kits/det-monitor/Marketing.jsx":"0b94ba473a20","ui_kits/det-monitor/Sidebar.jsx":"091451a6abb5","ui_kits/det-monitor/Topbar.jsx":"9fb94ea5b863"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.Juris8DesignSystem_75d483 = window.Juris8DesignSystem_75d483 || {});
...
function Alert({
  ...
  }, icon), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", {
    style: {
      fontSize: 12.5,
      color: 'var(--text)',
      lineHeight: 1.35,
  ...
  }, description)), time && /*#__PURE__*/React.createElement("time", {
    style: {
  ...
  }, time)), (tag || action) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 7,
      alignItems: 'center',
  ...
  }, tag), action && /*#__PURE__*/React.createElement("button", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 9,
      borderRadius: 'var(--r-2)',
...
function Button({
  ...
  const hoverStyle = !disabled && hover ? variant === 'primary' ? {
    ...
    transform: 'translateY(-1px)',
    borderColor: 'rgba(179,136,251,0.25)'
  } : variant === 'ghost' ? {
...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      position: 'relative',
      background: featured ? 'linear-gradient(145deg, rgba(76,26,158,0.28), rgba(20,17,42,0.92))' : 'var(--surface-1)',
      border: `1px solid ${featured ? 'rgba(124,58,237,0.5)' : 'var(--hairline-strong)'}`,
      borderRadius: 'var(--r-7)',
      padding,
      boxShadow: featured ? '0 0 0 1px rgba(124,58,237,0.1), 0 24px 56px -32px rgba(124,58,237,0.3)' : isHover ? '0 22px 48px -28px rgba(124,58,237,0.2)' : 'none',
...
// site/mockup9-embed/dist/assets/index-D5YeOlk5.js
try { (() => {
var e = Object.create,
...
var f = s(e => {
    ...
    function ce(e, r, i, a, o) {
      ...
      c = 0;
      var l = a === `` ? `.` : a + `:`;
      if (S(e)) for (var u = 0; u < e.length; u++) a = e[u], s = l + oe(a, u), c += ce(a, r, i, s, o);else if (u = m(e), typeof u == `function`) for (e = u.call(e), u = 0; !(a = e.next()).done;) a = a.value, s = l + oe(a, u++), c += ce(a, r, i, s, o);else if (s === `object`) {
    ...
    e.Activity = f, e.Children = E, e.Component = v, e.Fragment = r, e.Profiler = a, e.PureComponent = b, e.StrictMode = i, e.Suspense = l, e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = w, e.__COMPILER_RUNTIME = {
      ...
      if (o === 1) i.children = n;else if (1 < o) {
  ...
  m = s(e => {
    ...
    function x(e) {
      if (h = !1, b(e), !m) if (n(c) !== null) m = !0, S || (S = !0, re());else {
        var t = n(l);
  ...
  v = s(e => {
    ...
    function u(e) {
      ...
      for (var n = e, r = t;;) {
        ...
        if (n.return !== r.return) n = a, r = s;else {
    ...
    function be(e, t) {
      switch (D(ve, t), D(_e, e), D(ge, null), t.nodeType) {
        ...
        case 11:
          ...
          break;
        default:
          if (e = t.tagName, t = t.namespaceURI) t = Vd(t), e = Hd(t, e);else switch (e) {
            case `svg`:
              e = 1;
              break;
            case `math`:
...
` + e.stack;
    ...
    var mt = Math.random().toString(36).slice(2),
      A = `__reactFiber$` + mt,
      j = `__reactProps$` + mt,
      ht = `__reactContainer$` + mt,
      gt = `__reactEvents$` + mt,
      _t = `__reactListeners$` + mt,
      vt = `__reactHandles$` + mt,
      yt = `__reactResources$` + mt,
      bt = `__reactMarker$` + mt;
    function xt(e) {
      delete e[A], delete e[j], delete e[gt], delete e[_t], delete e[vt];
    }
    function St(e) {
      var t = e[A];
      if (t) return t;
    ...
    function Ft(e, t, n) {
      if (Pt(t)) if (n === null) e.removeAttribute(t);else {
        switch (typeof n) {
          case `undefined`:
          case `function`:
          case `symbol`:
    ...
    function Lt(e, t, n, r) {
      if (r === null) e.removeAttribute(n);else {
        switch (typeof r) {
          case `undefined`:
          case `function`:
          case `symbol`:
    ...
    function Vt(e) {
      ...
      var n = t.getValue(),
        r = ``;
      return e && (r = M(e) ? e.checked ? `true` : `false` : e.value), e = r, e === n ? !1 : (t.setValue(e), !0);
    }
    function Ht(e) {
    ...
    function Xt(e, t, n, r) {
      ...
      n = Rt(t), e.defaultValue = n, r = e.textContent, r === n && r !== `` && r !== null && (e.value = r), Bt(e);
    }
    function Zt(e, t) {
      if (t) {
        var n = e.firstChild;
    ...
    function Or(e, t) {
      ...
      for (r = 0; r < n.length; r++) {
        var i = n[r];
        if (!je.call(t, i) || !Dr(e[i], t[i])) return !1;
      }
      return !0;
    }
    function kr(e) {
    ...
    function _i(e, t, n, r, a, o) {
      var s = 0;
      if (r = e, typeof e == `function`) mi(e) && (s = 1);else if (typeof e == `string`) s = Uf(e, n, ge.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;else a: switch (e) {
        case ie:
          return e = pi(31, n, t, a), e.elementType = ie, e.lanes = o, e;
        case y:
        ...
        case ee:
          return e = pi(13, n, t, a), e.elementType = ee, e.lanes = o, e;
        case te:
          return e = pi(19, n, t, a), e.elementType = te, e.lanes = o, e;
        default:
    ...
    var Yi = me(null),
      ...
      Zi = null;
    function Qi(e, t, n) {
      D(Yi, t._currentValue), t._currentValue = n;
    }
    function $i(e) {
      e._currentValue = Yi.current, he(Yi);
    }
    function ea(e, t, n) {
      for (; e !== null;) {
        var r = e.alternate;
    ...
    function ta(e, t, n, r) {
      ...
      for (a !== null && (a.return = e); a !== null;) {
        ...
        if (s !== null) s.return = a;else for (s = a; s !== null;) {
          if (s === e) {
            s = null;
            break;
          }
    ...
    function na(e, t, n, r) {
      ...
      for (var a = t, o = !1; a !== null;) {
        if (!o) {
          if (a.flags & 524288) o = !0;else if (a.flags & 262144) break;
        }
        if (a.tag === 10) {
          var s = a.alternate;
    ...
    function Aa(e, t, n) {
      switch (n = e[n], n === void 0 ? e.push(t) : n !== t && (t.then(an, an), t = n), t.status) {
        ...
        default:
          if (typeof t.status == `string`) t.then(an, an);else {
    ...
    function Ba(e) {
      ...
      function l(e, t, n, r) {
        var i = n.type;
        return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === re && ja(i) === t.type) ? (t = a(t, n.props), Ra(t, n), t.return = e, t) : (t = _i(n.type, n.key, n.props, null, e.mode, r), Ra(t, n), t.return = e, t);
      }
      function u(e, t, n, r) {
    ...
    var to = me(null),
      no = me(0);
    function ro(e, t) {
      e = Wl, D(no, e), D(to, t), Wl = e | t.baseLanes;
    }
    function io() {
      D(no, Wl), D(to, to.current);
    }
    function ao() {
      Wl = no.current, he(to), he(no);
    }
    var oo = me(null),
      so = null;
    function co(e) {
      var t = e.alternate;
      D(L, L.current & 1), D(oo, e), so === null && (t === null || to.current !== null || t.memoizedState !== null) && (so = e);
    }
    function lo(e) {
      D(L, L.current), D(oo, e), so === null && (so = e);
    }
    function uo(e) {
      e.tag === 22 ? (D(L, L.current), D(oo, e), so === null && (so = e)) : fo(e);
    }
    function fo() {
      D(L, L.current), D(oo, oo.current);
    }
    function po(e) {
      he(oo), so === e && (so = null), he(L);
    }
    var L = me(0);
    function mo(e) {
      for (var t = e; t !== null;) {
    ...
    function To(e, t, n, r, i, a) {
      return ho = a, R = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, T.H = e === null || e.memoizedState === null ? Hs : Us, yo = !1, a = n(r, i), yo = !1, vo && (a = Do(t, n, r, i)), Eo(e), a;
    }
    function Eo(e) {
      T.H = Vs;
      var t = z !== null && z.next !== null;
      if (ho = 0, go = z = R = null, _o = !1, xo = 0, So = null, t) throw Error(i(300));
      e === null || oc || (e = e.dependencies, e !== null && ra(e) && (oc = !0));
    }
    function Do(e, t, n, r) {
      R = e;
      var a = 0;
    ...
    function Fo(e) {
      var t = xo;
      return xo += 1, So === null && (So = []), e = Aa(So, e, t), t = R, (go === null ? t.memoizedState : go.next) === null && (t = t.alternate, T.H = t === null || t.memoizedState === null ? Hs : Us), e;
    }
    function Io(e) {
      if (typeof e == `object` && e) {
    ...
    function Lo(e) {
      ...
      if (t ??= {
        data: [],
        index: 0
      }, n === null && (n = Po(), R.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = ae;
      return t.index++, n;
    }
    function Ro(e, t) {
    ...
    function Bo(e, t, n) {
      ...
      if (o = e.baseState, a === null) e.memoizedState = o;else {
        t = a.next;
        var c = s = null,
          l = null,
          u = t,
        ...
        if (l === null ? s = o : l.next = c, !Dr(o, e.memoizedState) && (oc = !0, d && (n = _a, n !== null))) throw n;
    ...
    function Vo(e) {
      ...
      if (a !== null) {
        ...
        Dr(o, t.memoizedState) || (oc = !0), t.memoizedState = o, t.baseQueue === null && (t.baseState = o), n.lastRenderedState = o;
      }
      return [o, r];
    }
    function Ho(e, t, n) {
      ...
      if (s && (a.memoizedState = n, oc = !0), a = a.queue, ps(Go.bind(null, r, a, e), [e]), a.getSnapshot !== t || s || go !== null && go.memoizedState.tag & 1) {
        if (r.flags |= 2048, cs(9, {
          destroy: void 0
        }, Wo.bind(null, r, a, n, t), null), K === null) throw Error(i(349));
        o || ho & 127 || Uo(r, t, n);
      }
      return n;
    }
    ...
    function es(e, t, n) {
      ...
      if (e.pending = null, r !== null) {
        r = r.next;
        do t.status = `rejected`, t.reason = n, ts(t), t = t.next; while (t !== r);
      }
      e.action = null;
    }
    function ts(e) {
    ...
    function rs(e, t) {
      ...
      return n = Mo(), n.memoizedState = n.baseState = t, r = {
        ...
        lastRenderedState: t
      }, n.queue = r, n = Fs.bind(null, R, r), r.dispatch = n, r = Jo(!1), a = Ls.bind(null, R, !1, r.queue), r = Mo(), i = {
        state: t,
        dispatch: null,
        action: e,
        pending: null
      }, r.queue = i, n = Xo.bind(null, R, i, a, n), i.dispatch = n, r.memoizedState = e, [t, n, !1];
    }
    function is(e) {
      return as(No(), z, e);
    }
    function as(e, t, n) {
      ...
      var i = t.queue,
        a = i.dispatch;
      return n !== t.memoizedState && (R.flags |= 2048, cs(9, {
        destroy: void 0
      }, os.bind(null, i, n), null)), [r, a, e];
    }
    function os(e, t) {
      e.action = t;
    }
    ...
    function us(e, t, n, r) {
      var i = Mo();
      R.flags |= e, i.memoizedState = cs(1 | t, {
        destroy: void 0
      }, n, r === void 0 ? null : r);
    }
    function ds(e, t, n, r) {
      ...
      z !== null && r !== null && wo(r, z.memoizedState.deps) ? i.memoizedState = cs(t, a, n, r) : (R.flags |= e, i.memoizedState = cs(1 | t, a, n, r));
    }
    function fs(e, t) {
      us(8390656, 8, e, t);
    }
    ...
    function ms(e) {
      R.flags |= 4;
      var t = R.updateQueue;
      if (t === null) t = Po(), R.updateQueue = t, t.events = [e];else {
        var n = t.events;
    ...
    function ws(e, t, n, r) {
      return Dr(n, t) ? n : to.current === null ? !(ho & 42) || ho & 1073741824 && !(J & 261930) ? (oc = !0, e.memoizedState = n) : (e = mu(), R.lanes |= e, Gl |= e, t) : (e = Cs(e, n, r), Dr(e, t) || (oc = !0), e);
    }
    function Ts(e, t, n, r, i) {
      ...
      try {
        var c = i(),
          l = T.S;
        l !== null && l(s, c), typeof c == `object` && c && typeof c.then == `function` ? Is(e, t, ba(c, r), pu(e)) : Is(e, t, r, pu(e));
      } catch (n) {
        Is(e, t, {
          then: function () {},
          status: `rejected`,
    ...
    function Ps(e, t, n) {
      ...
      n = {
        ...
        eagerState: null,
        next: null
      }, Rs(e) ? zs(t, n) : (n = si(e, t, n, r), n !== null && (hu(n, e, r), Bs(n, t, r)));
    }
    function Fs(e, t, n) {
      Is(e, t, n, pu());
    }
    function Is(e, t, n, r) {
      ...
      if (Rs(e)) zs(t, i);else {
        ...
        if (n = si(e, t, i, r), n !== null) return hu(n, e, r), Bs(n, t, r), !0;
      }
      return !1;
    }
    function Ls(e, t, n, r) {
    ...
    var Hs = {
        ...
        useReducer: function (e, t, n) {
          ...
          return r.memoizedState = r.baseState = i, e = {
            ...
            lastRenderedState: i
          }, r.queue = e, e = e.dispatch = Ps.bind(null, R, e), [r.memoizedState, e];
        },
        useRef: function (e) {
          var t = Mo();
          return e = {
        ...
        useTransition: function () {
          var e = Jo(!1);
          return e = Ts.bind(null, R, e.queue, !0, !1), Mo().memoizedState = e, [!1, e];
        },
        useSyncExternalStore: function (e, t, n) {
          ...
          return a.queue = o, fs(Go.bind(null, r, o, e), [e]), r.flags |= 2048, cs(9, {
            destroy: void 0
        ...
        useOptimistic: function (e) {
          ...
          return t.queue = n, t = Ls.bind(null, R, !0, n), n.dispatch = t, [e, t];
        },
        useMemoCache: Lo,
        useCacheRefresh: function () {
          return Mo().memoizedState = Ns.bind(null, R);
        },
    ...
    function ic(e, t, n, r, a) {
      if (n.flags |= 32768, typeof r == `object` && r && typeof r.then == `function`) {
        if (t = n.alternate, t !== null && na(t, n, a, !0), n = oo.current, n !== null) {
          switch (n.tag) {
            case 31:
            case 13:
              return so === null ? Du() : n.alternate === null && X === 0 && (X = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Oa ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = new Set([r]) : t.add(r), Gu(e, r, a)), !1;
            case 22:
      ...
      if (F) return t = oo.current, t === null ? (r !== Vi && (t = Error(i(423), {
        cause: r
      }), Ji(Ci(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = Ci(r, n), a = tc(e.stateNode, r, a), Ya(e, a), X !== 4 && (X = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== Vi && (e = Error(i(422), {
        cause: r
      }), Ji(Ci(e, n)))), !1;
      var o = Error(i(520), {
        cause: r
      ...
      do {
        switch (n.tag) {
          case 3:
            return n.flags |= 65536, e = a & -a, n.lanes |= e, e = tc(n.stateNode, r, e), Ya(n, e), !1;
          case 1:
            if (t = n.type, o = n.stateNode, !(n.flags & 128) && (typeof t.getDerivedStateFromError == `function` || o !== null && typeof o.componentDidCatch == `function` && (ru === null || !ru.has(o)))) return n.flags |= 65536, a &= -a, n.lanes |= a, a = nc(a), rc(a, e, n, r), Ya(n, a), !1;
        }
        n = n.return;
      } while (n !== null);
      return !1;
    ...
    function cc(e, t, n, r, i) {
      ...
      return ia(t), r = To(e, t, n, o, a, i), s = ko(), e !== null && !oc ? (Ao(e, t, i), jc(e, t, i)) : (F && s && Fi(t), t.flags |= 1, sc(e, t, r, i), t.child);
    }
    function lc(e, t, n, r, i) {
      if (e === null) {
        var a = n.type;
        return typeof a == `function` && !mi(a) && a.defaultProps === void 0 && n.compare === null ? (t.tag = 15, t.type = a, uc(e, t, a, r, i)) : (e = _i(n.type, null, r, t, t.mode, i), e.ref = t.ref, e.return = t, t.child = e);
      }
      if (a = e.child, !Mc(e, i)) {
    ...
    function uc(e, t, n, r, i) {
      if (e !== null) {
        ...
        if (Or(a, r) && e.ref === t.ref) if (oc = !1, t.pendingProps = r = a, Mc(e, i)) e.flags & 131072 && (oc = !0);else return t.lanes = e.lanes, jc(e, t, i);
      }
      return vc(e, t, n, r, i);
    }
    function dc(e, t, n, r) {
      ...
      if (e === null && t.stateNode === null && (t.stateNode = {
        ...
        if (n & 536870912) t.memoizedState = {
          baseLanes: 0,
          cachePool: null
        }, e !== null && wa(t, a === null ? null : a.cachePool), a === null ? io() : ro(t, a), uo(t);else return r = t.lanes = 536870912, pc(e, t, a === null ? n : a.baseLanes | n, n, r);
    ...
    function pc(e, t, n, r, i) {
      ...
      return a = a === null ? null : {
        ...
        baseLanes: n,
        cachePool: a
      }, e !== null && wa(t, null), io(), uo(t), e !== null && na(e, t, r, !0), t.childLanes = i, null;
    }
    function mc(e, t) {
      return t = Ec({
        mode: t.mode,
    ...
    function gc(e, t, n) {
      ...
      if (o !== null) {
        var s = o.dehydrated;
        if (lo(t), a) {
          if (t.flags & 256) t.flags &= -257, t = hc(e, t, n);else if (t.memoizedState !== null) t.child = e.child, t.flags |= 128, t = null;else throw Error(i(558));
        } else if (oc || na(e, t, n, !1), a = (n & e.childLanes) !== 0, oc || a) {
          if (r = K, r !== null && (s = lt(r, n), s !== 0 && s !== o.retryLane)) throw o.retryLane = s, ci(e, s), hu(r, e, s), ac;
          Du(), t = hc(e, t, n);
        } else e = o.treeContext, P = cf(s.nextSibling), Ri = t, F = !0, zi = null, Bi = !1, e !== null && Li(t, e), t = mc(t, r), t.flags |= 4096;
        return t;
      }
      return e = hi(e.child, {
        mode: r.mode,
    ...
    function vc(e, t, n, r, i) {
      return ia(t), n = To(e, t, n, r, void 0, i), r = ko(), e !== null && !oc ? (Ao(e, t, i), jc(e, t, i)) : (F && r && Fi(t), t.flags |= 1, sc(e, t, n, i), t.child);
    }
    function yc(e, t, n, r, i, a) {
      return ia(t), t.updateQueue = null, n = Do(t, r, n, i), Eo(e), r = ko(), e !== null && !oc ? (Ao(e, t, a), jc(e, t, a)) : (F && r && Fi(t), t.flags |= 1, sc(e, t, n, a), t.child);
    }
    function bc(e, t, n, r, i) {
      if (ia(t), t.stateNode === null) {
        var a = di,
          o = n.contextType;
        typeof o == `object` && o && (a = aa(o)), a = new n(r, a), t.memoizedState = a.state !== null && a.state !== void 0 ? a.state : null, a.updater = Ks, t.stateNode = a, a._reactInternals = t, a = t.stateNode, a.props = r, a.state = t.memoizedState, a.refs = {}, Wa(t), o = n.contextType, a.context = typeof o == `object` && o ? aa(o) : di, a.state = t.memoizedState, o = n.getDerivedStateFromProps, typeof o == `function` && (Gs(t, n, o, r), a.state = t.memoizedState), typeof n.getDerivedStateFromProps == `function` || typeof a.getSnapshotBeforeUpdate == `function` || typeof a.UNSAFE_componentWillMount != `function` && typeof a.componentWillMount != `function` || (o = a.state, typeof a.componentWillMount == `function` && a.componentWillMount(), typeof a.UNSAFE_componentWillMount == `function` && a.UNSAFE_componentWillMount(), o !== a.state && Ks.enqueueReplaceState(a, a.state, null), Qa(t, r, a, i), Za(), a.state = t.memoizedState), typeof a.componentDidMount == `function` && (t.flags |= 4194308), r = !0;
      } else if (e === null) {
        a = t.stateNode;
      ...
      return a = r, _c(e, t), r = (t.flags & 128) != 0, a || r ? (a = t.stateNode, n = r && typeof n.getDerivedStateFromError != `function` ? null : a.render(), t.flags |= 1, e !== null && r ? (t.child = Va(t, e.child, null, i), t.child = Va(t, null, n, i)) : sc(e, t, n, i), t.memoizedState = a.state, e = t.child) : e = jc(e, t, i), e;
    }
    function xc(e, t, n, r) {
      return Ki(), t.flags |= 256, sc(e, t, n, r), t.child;
    }
    var Sc = {
      dehydrated: null,
      treeContext: null,
    ...
    function wc(e, t, n) {
      ...
      if ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (L.current & 2) != 0), s && (a = !0, t.flags &= -129), s = (t.flags & 32) != 0, t.flags &= -33, e === null) {
        ...
        return r = r.fallback, a ? (fo(t), a = t.mode, c = Ec({
          mode: `hidden`,
          children: c
        }, a), r = vi(r, a, n, null), c.return = t, r.return = t, c.sibling = r, t.child = c, r = t.child, r.memoizedState = Cc(n), r.childLanes = V(e, s, n), t.memoizedState = Sc, fc(null, r)) : (co(t), Tc(t, c));
      }
      ...
      if (l !== null && (c = l.dehydrated, c !== null)) {
        if (o) t.flags & 256 ? (co(t), t.flags &= -257, t = Dc(e, t, n)) : t.memoizedState === null ? (fo(t), c = r.fallback, a = t.mode, r = Ec({
          mode: `visible`,
          children: r.children
        }, a), c = vi(c, a, n, null), c.flags |= 2, r.return = t, c.return = t, r.sibling = c, t.child = r, Va(t, e.child, null, n), r = t.child, r.memoizedState = Cc(n), r.childLanes = V(e, s, n), t.memoizedState = Sc, t = fc(null, r)) : (fo(t), t.child = e.child, t.flags |= 128, t = null);else if (co(t), of(c)) {
        ...
        } else if (oc || na(e, t, n, !1), s = (n & e.childLanes) !== 0, oc || s) {
          if (s = K, s !== null && (r = lt(s, n), r !== 0 && r !== l.retryLane)) throw l.retryLane = r, ci(e, r), hu(s, e, r), ac;
          af(c) || Du(), t = Dc(e, t, n);
        } else af(c) ? (t.flags |= 192, t.child = e.child, t = null) : (e = l.treeContext, P = cf(c.nextSibling), Ri = t, F = !0, zi = null, Bi = !1, e !== null && Li(t, e), t = Tc(t, r.children), t.flags |= 4096);
        return t;
      }
      return a ? (fo(t), c = r.fallback, a = t.mode, l = e.child, u = l.sibling, r = hi(l, {
        mode: `hidden`,
        children: r.children
      }), r.subtreeFlags = l.subtreeFlags & 65011712, u === null ? (c = vi(c, a, n, null), c.flags |= 2) : c = hi(u, c), c.return = t, r.return = t, r.sibling = c, t.child = r, fc(null, r), r = t.child, c = e.child.memoizedState, c === null ? c = Cc(n) : (a = c.cachePool, a === null ? a = Ta() : (l = da._currentValue, a = a.parent === l ? a : {
        parent: l,
        pool: l
      }), c = {
        baseLanes: c.baseLanes | n,
        cachePool: a
      }), r.memoizedState = c, r.childLanes = V(e, s, n), t.memoizedState = Sc, fc(e.child, r)) : (co(t), n = e.child, e = n.sibling, n = hi(n, {
        mode: `visible`,
        children: r.children
    ...
    function Ac(e, t, n) {
      ...
      var o = L.current,
        s = (o & 2) != 0;
      if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, D(L, o), sc(e, t, r, n), r = F ? Di : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
        if (e.tag === 13) e.memoizedState !== null && Oc(e, n, t);else if (e.tag === 19) Oc(e, n, t);else if (e.child !== null) {
    ...
    function Nc(e, t, n) {
      switch (t.tag) {
        case 3:
          be(t, t.stateNode.containerInfo), Qi(t, da, e.memoizedState.cache), Ki();
          break;
        case 27:
        case 5:
          Se(t);
        ...
        case 19:
          ...
          if (i = t.memoizedState, i !== null && (i.rendering = null, i.tail = null, i.lastEffect = null), D(L, L.current), r) break;
          return null;
        case 22:
    ...
    function Pc(e, t, n) {
      if (e !== null) {
        if (e.memoizedProps !== t.pendingProps) oc = !0;else {
          if (!Mc(e, n) && !(t.flags & 128)) return oc = !1, Nc(e, t, n);
          oc = !!(e.flags & 131072);
        }
      } else oc = !1, F && t.flags & 1048576 && Pi(t, Di, t.index);
      switch (t.lanes = 0, t.tag) {
        case 16:
          a: {
            var r = t.pendingProps;
            if (e = ja(t.elementType), t.type = e, typeof e == `function`) mi(e) ? (r = Ys(e, r), t.tag = 1, t = bc(null, t, e, r, n)) : (t.tag = 0, t = vc(null, t, e, r, n));else {
              if (e != null) {
                var a = e.$$typeof;
                if (a === w) {
        ...
        case 3:
          a: {
            ...
            if (r = s.cache, Qi(t, da, r), r !== o.cache && ta(t, [da], n, !0), Za(), r = s.element, o.isDehydrated) {
              if (o = {
                element: r,
                isDehydrated: !1,
                cache: s.cache
                ...
                a = Ci(Error(i(424)), t), Ji(a), t = xc(e, t, r, n);
                break a;
              } else {
          ...
          return t;
        case 26:
          return _c(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : F || (n = t.type, e = t.pendingProps, r = Bd(ve.current).createElement(n), r[A] = t, r[j] = e, Pd(r, n, e), Et(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
        case 27:
          return Se(t), e === null && F && (r = t.stateNode = ff(t.type, t.pendingProps, ve.current), Ri = t, Bi = !0, a = P, Zd(t.type) ? (lf = a, P = cf(r.firstChild)) : P = a), sc(e, t, t.pendingProps.children, n), _c(e, t), e === null && (t.flags |= 4194304), t.child;
        case 5:
          return e === null && F && ((a = r = P) && (r = tf(r, t.type, t.pendingProps, Bi), r === null ? a = !1 : (t.stateNode = r, Ri = t, P = cf(r.firstChild), Bi = !1, a = !0)), a || Hi(t)), Se(t), a = t.type, o = t.pendingProps, s = e === null ? null : e.memoizedProps, r = o.children, Ud(a, o) ? r = null : s !== null && Ud(a, s) && (t.flags |= 32), t.memoizedState !== null && (a = To(e, t, Oo, null, null, n), Qf._currentValue = a), _c(e, t), sc(e, t, r, n), t.child;
        case 6:
          return e === null && F && ((e = n = P) && (n = nf(n, t.pendingProps, Bi), n === null ? e = !1 : (t.stateNode = n, Ri = t, P = null, e = !0)), e || Hi(t)), null;
        case 13:
          return wc(e, t, n);
        case 4:
          return be(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = Va(t, null, r, n) : sc(e, t, r, n), t.child;
        case 11:
        ...
        case 12:
          return sc(e, t, t.pendingProps.children, n), t.child;
        case 10:
          return r = t.pendingProps, Qi(t, t.type, r.value), sc(e, t, r.children, n), t.child;
        case 9:
          return a = t.type._context, r = t.pendingProps.children, ia(t), a = aa(a), r = r(a), t.flags |= 1, sc(e, t, r, n), t.child;
        case 14:
        ...
        case 24:
          return ia(t), r = aa(da), e === null ? (a = Ca(), a === null && (a = K, o = fa(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
            parent: r,
            cache: a
          }, Wa(t), Qi(t, da, a)) : ((e.lanes & n) !== 0 && (Ga(e, t), Qa(t, null, null, n), Za()), a = e.memoizedState, o = t.memoizedState, a.parent === r ? (r = o.cache, Qi(t, da, r), r !== a.cache && ta(t, [da], n, !0)) : (a = {
            parent: r,
            cache: r
          }, t.memoizedState = a, t.lanes === 0 && (t.memoizedState = t.updateQueue.baseState = a), Qi(t, da, r))), sc(e, t, t.pendingProps.children, n), t.child;
        case 29:
    ...
    function Ic(e, t, n, r, i) {
      if ((t = (e.mode & 32) != 0) && (t = !1), t) {
        if (e.flags |= 16777216, (i & 335544128) === i) if (e.stateNode.complete) e.flags |= 8192;else if (wu()) e.flags |= 8192;else throw Ma = Oa, Da;
      } else e.flags &= -16777217;
    }
    function Lc(e, t) {
      if (t.type !== `stylesheet` || t.state.loading & 4) e.flags &= -16777217;else if (e.flags |= 16777216, !Wf(t)) if (wu()) e.flags |= 8192;else throw Ma = Oa, Da;
    }
    function Rc(e, t) {
    ...
    function H(e) {
      var t = e.alternate !== null && e.alternate.child === e.child,
        n = 0,
        r = 0;
      if (t) for (var i = e.child; i !== null;) n |= i.lanes | i.childLanes, r |= i.subtreeFlags & 65011712, r |= i.flags & 65011712, i.return = e, i = i.sibling;else for (i = e.child; i !== null;) n |= i.lanes | i.childLanes, r |= i.subtreeFlags, r |= i.flags, i.return = e, i = i.sibling;
    ...
    function Bc(e, t, n) {
      ...
      switch (Ii(t), t.tag) {
        ...
        case 1:
          return H(t), null;
        case 3:
          return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), $i(da), xe(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (Gi(t) ? Fc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, qi())), H(t), null;
        case 26:
          var a = t.type,
            o = t.memoizedState;
        ...
        case 27:
          if (Ce(t), n = ve.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Fc(t);else {
            if (!r) {
              if (t.stateNode === null) throw Error(i(166));
              return H(t), null;
            }
            e = ge.current, Gi(t) ? Ui(t, e) : (e = ff(a, r, n), t.stateNode = e, Fc(t));
          }
          return H(t), null;
        case 5:
          if (Ce(t), a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Fc(t);else {
            if (!r) {
              if (t.stateNode === null) throw Error(i(166));
              return H(t), null;
            }
            if (o = ge.current, Gi(t)) Ui(t, o);else {
              var s = Bd(ve.current);
              switch (o) {
                case 1:
              ...
              a: for (s = t.child; s !== null;) {
                if (s.tag === 5 || s.tag === 6) o.appendChild(s.stateNode);else if (s.tag !== 4 && s.tag !== 27 && s.child !== null) {
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Fc(t);else {
            if (typeof r != `string` && t.stateNode === null) throw Error(i(166));
            if (e = ve.current, Gi(t)) {
              if (e = t.stateNode, n = t.memoizedProps, r = null, a = Ri, a !== null) switch (a.tag) {
                case 27:
                case 5:
                  r = a.memoizedProps;
              }
              e[A] = t, e = !!(e.nodeValue === n || r !== null && !0 === r.suppressHydrationWarning || Md(e.nodeValue, n)), e || Hi(t, !0);
        ...
        case 10:
          return $i(t.type), H(t), null;
        case 19:
          if (he(L), r = t.memoizedState, r === null) return H(t), null;
          if (a = (t.flags & 128) != 0, o = r.rendering, o === null) {
            if (a) zc(r, !1);else {
              if (X !== 0 || e !== null && e.flags & 128) for (e = t.child; e !== null;) {
                if (o = mo(e), o !== null) {
                  for (t.flags |= 128, zc(r, !1), e = o.updateQueue, t.updateQueue = e, Rc(t, e), t.subtreeFlags = 0, e = n, n = t.child; n !== null;) gi(n, e), n = n.sibling;
                  return D(L, L.current & 1 | 2), F && Ni(t, r.treeForkCount), t.child;
                }
                e = e.sibling;
              }
            ...
            if (!a) if (e = mo(o), e !== null) {
              if (t.flags |= 128, a = !0, e = e.updateQueue, t.updateQueue = e, Rc(t, e), zc(r, !0), r.tail === null && r.tailMode === `hidden` && !o.alternate && !F) return H(t), null;
            } else 2 * Ie() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128, a = !0, zc(r, !1), t.lanes = 4194304);
            r.isBackwards ? (o.sibling = t.child, t.child = o) : (e = r.last, e === null ? t.child = o : e.sibling = o, r.last = o);
          }
          return r.tail === null ? (H(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ie(), e.sibling = null, n = L.current, D(L, a ? n & 1 | 2 : n & 1), F && Ni(t, r.treeForkCount), e);
        case 22:
        case 23:
          return po(t), ao(), r = t.memoizedState !== null, e === null ? r && (t.flags |= 8192) : e.memoizedState !== null !== r && (t.flags |= 8192), r ? n & 536870912 && !(t.flags & 128) && (H(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : H(t), n = t.updateQueue, n !== null && Rc(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== n && (t.flags |= 2048), e !== null && he(Sa), null;
        case 24:
          return n = null, e !== null && (n = e.memoizedState.cache), t.memoizedState.cache !== n && (t.flags |= 2048), $i(da), H(t), null;
        case 25:
          return null;
        case 30:
          return null;
    ...
    function Vc(e, t) {
      switch (Ii(t), t.tag) {
        ...
        case 3:
          return $i(da), xe(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
        case 26:
        case 27:
        case 5:
          return Ce(t), null;
        ...
        case 22:
        case 23:
          return po(t), ao(), e !== null && he(Sa), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
        case 24:
          return $i(da), null;
        case 25:
          return null;
    ...
    function $c(e, t, n) {
      var r = e.tag;
      if (r === 5 || r === 6) e = e.stateNode, t ? (n.nodeType === 9 ? n.body : n.nodeName === `HTML` ? n.ownerDocument.body : n).insertBefore(e, t) : (t = n.nodeType === 9 ? n.body : n.nodeName === `HTML` ? n.ownerDocument.body : n, t.appendChild(e), n = n._reactRootContainer, n != null || t.onclick !== null || (t.onclick = an));else if (r !== 4 && (r === 27 && Zd(e.type) && (n = e.stateNode, t = null), e = e.child, e !== null)) for ($c(e, t, n), e = e.sibling; e !== null;) $c(e, t, n), e = e.sibling;
    }
    function el(e, t, n) {
      var r = e.tag;
      if (r === 5 || r === 6) e = e.stateNode, t ? n.insertBefore(e, t) : n.appendChild(e);else if (r !== 4 && (r === 27 && Zd(e.type) && (n = e.stateNode), e = e.child, e !== null)) for (el(e, t, n), e = e.sibling; e !== null;) el(e, t, n), e = e.sibling;
    }
    function tl(e) {
      var t = e.stateNode,
        n = e.memoizedProps;
    ...
    function ol(e, t) {
      ...
      for (zd = {
        focusedElem: e,
        selectionRange: n
      }, sp = !1, al = t; al !== null;) if (t = al, e = t.child, t.subtreeFlags & 1028 && e !== null) e.return = t, al = e;else for (; al !== null;) {
        switch (t = al, o = t.alternate, e = t.flags, t.tag) {
          ...
          case 3:
            if (e & 1024) {
              if (e = t.stateNode.containerInfo, n = e.nodeType, n === 9) ef(e);else if (n === 1) switch (e.nodeName) {
                case `HEAD`:
                case `HTML`:
                case `BODY`:
                  ef(e);
              ...
              if (r === null) {
                if (e.stateNode === null) {
                  a: {
                    ...
                    b: switch (r) {
                      case `title`:
                        o = a.getElementsByTagName(`title`)[0], (!o || o[bt] || o[A] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r), a.head.insertBefore(o, a.querySelector(`head > title`))), Pd(o, r, n), o[A] = e, Et(o), r = o;
                        break a;
                      case `link`:
          ...
          if (nl = u || a, U = d || l, gl(t, e), U = d, nl = u, yl(e), r & 8192) a: for (t = e.stateNode, t._visibility = a ? t._visibility & -2 : t._visibility | 1, a && (n === null || l || nl || U || Sl(e)), n = null, t = e;;) {
            if (t.tag === 5 || t.tag === 26) {
              if (n === null) {
                l = n = t;
                try {
                  if (o = l.stateNode, a) s = o.style, typeof s.setProperty == `function` ? s.setProperty(`display`, `none`, `important`) : s.display = `none`;else {
                    c = l.stateNode;
    ...
    function Ll(e, t) {
      for (; al !== null;) {
        ...
        if (r = n.child, r !== null) r.return = n, al = r;else a: for (n = e; al !== null;) {
          r = al;
          var i = r.sibling,
            a = r.return;
          if (cl(r), r === n) {
    ...
    function gu(e, t, n) {
      ...
      do {
        if (a === 0) {
          ...
          if (a === 2) {
            if (o = t, e.errorRecoveryDisabledLanes & o) var s = 0;else s = e.pendingLanes & -536870913, s = s === 0 ? s & 536870912 ? 536870912 : 0 : s;
            if (s !== 0) {
              t = s;
              a: {
                var c = e;
    ...
    function xu() {
      if (q !== null) {
        if (Y === 0) var e = q.return;else e = q, Zi = Xi = null, jo(e), Fa = null, Ia = 0, e = q;
    ...
    function Cu(e, t) {
      R = null, T.H = Vs, t === Ea || t === I ? (t = Na(), Y = 3) : t === Da ? (t = Na(), Y = 4) : Y = t === ac ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1, Bl = t, q === null && (X = 1, $s(e, Ci(t, e.current)));
    }
    function wu() {
      var e = oo.current;
    ...
    function Ou(e, t, n) {
      ...
      return t && e.shellSuspendCounter++, Zi = Xi = null, G = r, T.H = i, T.A = a, q === null && (K = null, J = 0, ai()), o;
    }
    function ku() {
      for (; q !== null;) Mu(q);
    }
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      K !== e || J !== t ? (nu = null, tu = Ie() + 500, Su(e, t)) : Hl = tt(e, t);
      a: do try {
        if (Y !== 0 && q !== null) {
          t = q;
          var o = Bl;
      ...
      return Zi = Xi = null, T.H = r, T.A = a, G = n, q === null ? (K = null, J = 0, ai(), X) : 0;
    }
    function ju() {
      for (; q !== null && !Pe();) Mu(q);
    }
    ...
    function Nu(e) {
      ...
      switch (t.tag) {
        ...
        case 5:
          jo(t);
        default:
          Hc(n, t), t = q = gi(t, Wl), t = Pc(n, t, Wl);
      }
      e.memoizedProps = e.pendingProps, t === null ? Fu(e) : q = t;
    }
    function Pu(e, t, n, r) {
      Zi = Xi = null, jo(t), Fa = null, Ia = 0;
      var i = t.return;
      try {
        if (ic(e, i, t, n, J)) {
          X = 1, $s(e, Ci(n, e.current)), q = null;
          return;
        }
      } catch (t) {
    ...
    function Lu(e, t, n, r, a, o, s, c, l) {
      ...
      if (t !== null) {
        ...
        if (o = t.lanes | t.childLanes, o |= ii, ot(e, n, o, s, c, l), e === K && (q = K = null, J = 0), ou = t, au = e, su = n, cu = o, lu = a, uu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(Be, function () {
          return Uu(), null;
    ...
    function Wu(e, t, n) {
      t = Ci(n, t), t = tc(e.stateNode, t, 2), e = qa(e, t, 2), e !== null && (at(e, 2), rd(e));
    }
    function Z(e, t, n) {
      if (e.tag === 3) Wu(e, e, n);else for (; t !== null;) {
        if (t.tag === 3) {
          ...
          if (typeof t.type.getDerivedStateFromError == `function` || typeof r.componentDidCatch == `function` && (ru === null || !ru.has(r))) {
            e = Ci(n, e), n = nc(2), r = qa(t, n, 2), r !== null && (rc(n, r, t, e), at(r, 2), rd(r));
            break;
          }
        }
        t = t.return;
    ...
    function sd(e, t) {
      ...
      if (t = K, n = J, n = et(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r = e.callbackNode, n === 0 || e === t && (Y === 2 || Y === 9) || e.cancelPendingCommit !== null) return r !== null && r !== null && Ne(r), e.callbackNode = null, e.callbackPriority = 0;
      if (!(n & 3) || tt(e, n)) {
    ...
    function cd(e, t) {
      ...
      var r = J;
      return r = et(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (gu(e, r, t), sd(e, Ie()), e.callbackNode != null && e.callbackNode === n ? cd.bind(null, e) : null);
    }
    function ld(e, t) {
      if (Hu()) return null;
      gu(e, t, !0);
    ...
    function wd(e, t, n, r, i) {
      ...
      fn(function () {
        ...
        if (!(t & 7)) {
          a: {
            if (c = e === `mouseover` || e === `pointerover`, l = e === `mouseout` || e === `pointerout`, c && n !== on && (u = n.relatedTarget || n.fromElement) && (St(u) || u[ht])) break a;
          ...
          a: {
            if (c = r ? wt(r) : window, l = c.nodeName && c.nodeName.toLowerCase(), l === `select` || l === `input` && c.type === `file`) var v = hr;else if (lr(c)) {
              if (gr) v = Tr;else {
                v = Cr;
                var y = Sr;
              }
...
`).replace(Ad, ``);
    ...
    function $(e, t, n, r, a, o) {
      switch (n) {
        ...
        case `xlinkHref`:
          ...
          n = N(`` + r), e.setAttributeNS(`http://www.w3.org/1999/xlink`, `xlink:href`, n);
          break;
        ...
        case `textContent`:
          break;
        default:
          (!(2 < n.length) || n[0] !== `o` && n[0] !== `O` || n[1] !== `n` && n[1] !== `N`) && (n = nn.get(n) || n, Ft(e, n, r));
      }
    }
    ...
    function Qd(e, t) {
      ...
      do {
        ...
        if (e.removeChild(n), i && i.nodeType === 8) if (n = i.data, n === `/$` || n === `/&`) {
          ...
          r--;
        } else if (n === `$` || n === `$?` || n === `$~` || n === `$!` || n === `&`) r++;else if (n === `html`) pf(e.ownerDocument.documentElement);else if (n === `head`) {
    ...
    function Ef(e, t, n) {
      ...
      if (r && e) {
        ...
        if (!o) {
          ...
          if (o = r.querySelector(jf(a))) s.loading = 5;else {
            e = f({
              rel: `stylesheet`,
              href: e,
              "data-precedence": t
    ...
    function If(e, t, n) {
      if (t.count++, t.instance === null) switch (t.type) {
        ...
        case `script`:
          return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, Et(a), a) : (r = n, (a = mf.get(o)) && (r = f({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement(`script`), Et(a), Pd(a, `link`, r), e.head.appendChild(a), t.instance = a);
        case `void`:
          return null;
        default:
    ...
    function Lf(e, t, n) {
      for (var r = n.querySelectorAll(`link[rel="stylesheet"][data-precedence],style[data-precedence]`), i = r.length ? r[r.length - 1] : null, a = i, o = 0; o < r.length; o++) {
        var s = r[o];
        if (s.dataset.precedence === t) a = s;else if (a !== i) break;
      }
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (!(a[bt] || a[A] || e === `link` && a.getAttribute(`rel`) === `stylesheet`) && a.namespaceURI !== `http://www.w3.org/2000/svg`) {
    ...
    function Jf() {
      if (this.count--, this.count === 0 && (this.imgCount === 0 || !this.waitingForImages)) {
        if (this.stylesheets) Xf(this, this.stylesheets);else if (this.unsuspend) {
    ...
    function up(e, t, n, r) {
      if (sp) {
        var i = dp(r);
        if (i === null) wd(e, t, r, fp, n), Cp(e, r);else if (Tp(i, e, t, n, r)) r.stopPropagation();else if (Cp(e, r), t & 4 && -1 < Sp.indexOf(e)) {
          for (; i !== null;) {
            var a = Ct(i);
    ...
    function Np(e) {
      ...
      if (n = (e.ownerDocument || e).$$reactFormReplay, n != null) for (r = 0; r < n.length; r += 3) {
        var i = n[r],
          a = n[r + 1],
          o = i[j] || null;
        if (typeof a == `function`) o || Mp(n);else if (o) {
          var s = null;
          if (a && a.hasAttribute(`formAction`)) {
            if (i = a, o = a[j] || null) s = o.formAction;else if (pp(i) !== null) continue;
          } else s = o.action;
  ...
  b = s(e => {
    ...
    function r(e, n, r) {
      var i = null;
      if (r !== void 0 && (i = `` + r), n.key !== void 0 && (i = `` + n.key), `key` in n) for (var a in r = {}, n) a !== `key` && (r[a] = n[a]);else r = n;
      return n = r.ref, {
        $$typeof: t,
        type: e,
        key: i,
...
var ue = e => e,
  ...
  pe = e => e / 1e3,
  me = (e, t) => t ? 1e3 / t * e : 0,
  he = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e,
  D = 1e-7,
  ge = 12;
function _e(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do o = t + (n - t) / 2, a = he(o, r, i) - e, a > 0 ? n = o : t = o; while (Math.abs(a) > D && ++s < ge);
  return o;
}
function ve(e, t, n, r) {
...
var ye = e => t => t <= .5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2,
  be = e => t => 1 - e(1 - t),
  xe = ve(.33, 1.53, .69, .99),
  Se = be(xe),
  Ce = ye(Se),
  we = e => e >= 1 ? 1 : (e *= 2) < 1 ? .5 * Se(e) : .5 * (2 - 2 ** (-10 * (e - 1))),
  ...
  Ie = [`setup`, `read`, `resolveKeyframes`, `preUpdate`, `update`, `preRender`, `render`, `postRender`],
  Le = {
    value: null,
...
function Re(e, t) {
  ...
  let u = {
    ...
    process: e => {
      ...
      i = !0;
      let o = n;
      n = r, r = o, n.forEach(l), t && Le.value && Le.value.frameloop[t].push(c), c = 0, n.clear(), i = !1, a && (a = !1, u.process(e));
    }
  };
  return u;
}
...
function Be(e, t) {
  let n = !1,
    ...
    h = () => {
      ...
      n = !1, a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, ze), 1)), i.timestamp = o, i.isProcessing = !0, s.process(i), c.process(i), l.process(i), u.process(i), d.process(i), f.process(i), p.process(i), m.process(i), i.isProcessing = !1, n && t && (r = !1, e(h));
    },
    g = () => {
...
var {
    ...
    state: He,
    steps: Ue
  } = Be(typeof requestAnimationFrame < `u` ? requestAnimationFrame : ue, !0),
  We;
function Ge() {
  We = void 0;
}
var k = {
    now: () => (We === void 0 && k.set(He.isProcessing || ae.useManualTiming ? He.timestamp : performance.now()), We),
    set: e => {
  ...
  qe = e => t => typeof t == `string` && t.startsWith(e),
  Je = qe(`--`),
  Ye = qe(`var(--`),
  Xe = e => Ye(e) ? Ze.test(e.split(`/*`)[0].trim()) : !1,
  Ze = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function Qe(e) {
...
var $e = {
  ...
  nt = e => Math.round(e * 1e5) / 1e5,
  rt = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
function it(e) {
  return e == null;
}
var at = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
  ot = (e, t) => n => !!(typeof n == `string` && at.test(n) && n.startsWith(e) || t && !it(n) && Object.prototype.hasOwnProperty.call(n, t)),
  st = (e, t, n) => r => {
  ...
  ut = {
    ...
    transform: ({
      ...
      blue: n,
      alpha: r = 1
    }) => `rgba(` + lt.transform(e) + `, ` + lt.transform(t) + `, ` + lt.transform(n) + `, ` + nt(et.transform(r)) + `)`
  };
function dt(e) {
  let t = ``,
    n = ``,
...
var ft = {
  ...
  vt = {
    ...
    transform: ({
      ...
      lightness: n,
      alpha: r = 1
    }) => `hsla(` + Math.round(e) + `, ` + A.transform(nt(t)) + `, ` + A.transform(nt(n)) + `, ` + nt(et.transform(r)) + `)`
  },
  yt = {
    test: e => ut.test(e) || ft.test(e) || vt.test(e),
    parse: e => ut.test(e) ? ut.parse(e) : vt.test(e) ? vt.parse(e) : ft.parse(e),
    transform: e => typeof e == `string` ? e : e.hasOwnProperty(`red`) ? ut.transform(e) : vt.transform(e),
    getAnimatableNone: e => {
      let t = yt.parse(e);
      return t.alpha = 0, yt.transform(t);
    }
  },
  bt = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
function xt(e) {
  return isNaN(e) && typeof e == `string` && (e.match(rt)?.length || 0) + (e.match(bt)?.length || 0) > 0;
}
var St = `number`,
  Ct = `color`,
  wt = `var`,
...
function Ot(e) {
  ...
  return {
    values: n,
    split: t.replace(Dt, e => (yt.test(e) ? (r.color.push(a), i.push(Ct), n.push(yt.parse(e))) : e.startsWith(Tt) ? (r.var.push(a), i.push(wt), n.push(e)) : (r.number.push(a), i.push(St), n.push(parseFloat(e))), ++a, Et)).split(Et),
    indexes: r,
    types: i
  };
}
...
function At({
  ...
  return r => {
    ...
    for (let a = 0; a < n; a++) if (i += e[a], r[a] !== void 0) {
      let e = t[a];
      e === St ? i += nt(r[a]) : e === Ct ? i += yt.transform(r[a]) : i += r[a];
    }
    return i;
  };
}
...
var Ut = (e, t) => {
    ...
    return e => (i.red = zt(n.red, r.red, e), i.green = zt(n.green, r.green, e), i.blue = zt(n.blue, r.blue, e), i.alpha = M(n.alpha, r.alpha, e), ut.transform(i));
  },
...
function qt(e) {
  return typeof e == `number` ? Kt : typeof e == `string` ? Xe(e) ? Rt : yt.test(e) ? Ut : Zt : Array.isArray(e) ? Jt : typeof e == `object` ? yt.test(e) ? Ut : Yt : Rt;
}
function Jt(e, t) {
  let n = [...e],
    r = n.length,
...
var Zt = (e, t) => {
  let n = Ft.createTransformer(t),
    r = Ot(e),
    i = Ot(t);
  return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? Wt.has(e) && !i.values.length || Wt.has(t) && !r.values.length ? Gt(e, t) : T(Jt(Xt(r, i), i.values), n) : (`${e}${t}`, Rt(e, t));
};
function Qt(e, t, n) {
  return typeof e == `number` && typeof t == `number` && typeof n == `number` ? M(e, t, n) : qt(e)(e, t);
}
var $t = e => {
    let t = ({
      timestamp: t
    ...
    return {
      ...
      stop: () => Ve(t),
      now: () => He.isProcessing ? He.timestamp : k.now()
    };
  },
  en = (e, t, n = 10) => {
    let r = ``,
...
function ln({
  ...
  bounce: t = N.bounce,
  velocity: n = N.velocity,
  mass: r = N.mass
}) {
  let i, a;
  N.maxDuration;
  let o = 1 - t;
  o = ie(N.minDamping, N.maxDamping, o), e = ie(N.minDuration, N.maxDuration, pe(e)), o < 1 ? (i = t => {
    let r = t * o,
      i = r * e,
      a = r - n,
      s = an(t, o),
...
function mn(e = N.visualDuration, t = N.bounce) {
  let n = typeof e == `object` ? e : {
    ...
    _ = pe(Math.sqrt(c / u)),
    v = Math.abs(g) < 5;
  r ||= v ? N.restSpeed.granular : N.restSpeed.default, i ||= v ? N.restDelta.granular : N.restDelta.default;
  let y, b, x, S, C, w;
  if (h < 1) x = an(_, h), S = (m + h * _ * g) / x, y = e => o - Math.exp(-h * _ * e) * (S * Math.sin(x * e) + g * Math.cos(x * e)), C = h * _ * S + g * x, w = h * _ * g - S * x, b = e => Math.exp(-h * _ * e) * (C * Math.sin(x * e) + w * Math.cos(x * e));else if (h === 1) {
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(nn(ee), tn),
        t = en(t => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {}
  };
...
mn.applyToOptions = e => {
  let t = rn(e, 100, mn);
  return e.ease = t.ease, e.duration = fe(t.duration), e.type = `keyframes`, e;
};
var hn = 5;
function gn(e, t, n) {
...
function vn(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    t && (a = T(Array.isArray(t) ? t[n] || ue : t, a)), r.push(a);
  }
  return r;
}
function yn(e, t, {
...
function wn({
  ...
  let i = je(r) ? r.map(Fe) : Fe(r),
    ...
    o = yn(Sn(n && n.length === t.length ? n : xn(t), e), t, {
...
var kn = class {
  ...
  jn = class extends kn {
    constructor(e) {
      ...
      }, Ke.mainThread++, this.options = e, this.initAnimation(), this.play(), e.autoplay === !1 && this.pause();
    }
    initAnimation() {
      let {
        options: e
      ...
      let {
        ...
        s = t || wn;
      s !== wn && typeof o[0] != `number` && (this.mixKeyframes = T(An, Qt(o[0], o[1])), o = [0, 100]);
      let c = s({
        ...e,
        keyframes: o
      });
    ...
    tick(e, t = !1) {
      ...
      if (u) {
        let e = Math.min(this.currentTime, r) / o,
          t = Math.floor(e),
          n = e % 1;
        !n && e >= 1 && (n = 1), n === 1 && t--, t = Math.min(t, u + 1), t % 2 && (d === `reverse` ? (n = 1 - n, f && (n -= f / o)) : d === `mirror` && (y = a)), v = ie(0, 1, n) * o;
      }
      let b;
      ...
      return S && p !== _n && (b.value = En(l, this.options, h, this.speed)), m && m(b.value), S && this.finish(), b;
    }
    then(e, t) {
      return this.finished.then(e, t);
    }
    ...
    get iterationDuration() {
      ...
      return this.duration + pe(e);
    }
    get time() {
      return pe(this.currentTime);
    }
    set time(e) {
      e = fe(e), this.currentTime = e, this.startTime === null || this.holdTime !== null || this.playbackSpeed === 0 ? this.holdTime = e : this.driver && (this.startTime = this.driver.now() - e / this.playbackSpeed), this.driver ? this.driver.start(!1) : (this.startTime = 0, this.state = `paused`, this.holdTime = e, this.tick(e));
    }
    ...
    set speed(e) {
      ...
      t && this.driver && this.updateTime(k.now()), this.playbackSpeed = e, t && this.driver && (this.time = pe(this.currentTime));
    }
    play() {
    ...
    teardown() {
      this.state = `idle`, this.stopDriver(), this.startTime = this.holdTime = null, Ke.mainThread--;
    }
    stopDriver() {
...
var Nn = e => e * 180 / Math.PI,
  Pn = e => In(Nn(Math.atan2(e[1], e[0]))),
  Fn = {
    x: 4,
    y: 5,
    translateX: 4,
  ...
  In = e => (e %= 360, e < 0 && (e += 360), e),
  Ln = Pn,
  Rn = e => Math.sqrt(e[0] * e[0] + e[1] * e[1]),
  zn = e => Math.sqrt(e[4] * e[4] + e[5] * e[5]),
  Bn = {
    x: 12,
    y: 13,
    z: 14,
    ...
    scaleY: zn,
    scale: e => (Rn(e) + zn(e)) / 2,
    rotateX: e => In(Nn(Math.atan2(e[6], e[5]))),
    rotateY: e => In(Nn(Math.atan2(-e[2], e[0]))),
    rotateZ: Ln,
    rotate: Ln,
...
var Gn = [`transformPerspective`, `x`, `y`, `z`, `translateX`, `translateY`, `translateZ`, `scale`, `scaleX`, `scaleY`, `rotate`, `rotateX`, `rotateY`, `rotateZ`, `skew`, `skewX`, `skewY`],
  Kn = new Set([...Gn, `pathRotation`]),
  qn = e => e === $e || e === j,
  Jn = new Set([`x`, `y`, `z`]),
  Yn = Gn.filter(e => !Jn.has(e));
function Xn(e) {
  let t = [];
  return Yn.forEach(n => {
    let r = e.getValue(n);
...
function nr() {
  if (er) {
    let e = Array.from(Qn).filter(e => e.needsMeasurement),
  ...
  er = !1, $n = !1, Qn.forEach(e => e.complete(tr)), Qn.clear();
}
function rr() {
  Qn.forEach(e => {
...
var ar = class {
    ...
    scheduleResolve() {
      this.state = `scheduled`, this.isAsync ? (Qn.add(this), $n || ($n = !0, O.read(rr), O.resolveKeyframes(nr))) : (this.readKeyframes(), this.complete());
    }
    readKeyframes() {
      let {
...
var ur = lr(() => window.ScrollTimeline !== void 0, `scrollTimeline`),
  dr = lr(() => {
    try {
  ...
  fr = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`,
  pr = {
    linear: `linear`,
    ease: `ease`,
    easeIn: `ease-in`,
...
function mr(e, t) {
  if (e) return typeof e == `function` ? dr() ? en(e, t) : `ease-out` : Me(e) ? fr(e) : Array.isArray(e) ? e.map(e => mr(e, t) || pr.easeOut) : pr[e];
}
function hr(e, t, n, {
  delay: r = 0,
  duration: i = 300,
  ...
  c && (u.offset = c);
  let d = mr(s, i);
  Array.isArray(d) && (u.easing = d), Le.value && Ke.waapi++;
  let f = {
    delay: r,
    duration: i,
  ...
  l && (f.pseudoElement = l);
  let p = e.animate(u, f);
  return Le.value && p.finished.finally(() => {
    Ke.waapi--;
  }), p;
}
function gr(e) {
...
var vr = class extends kn {
    ...
    set time(e) {
      ...
      this.manualStartTime = null, this.finishedTime = null, this.animation.currentTime = fe(e), t && this.animation.pause();
    }
    get speed() {
    ...
    attachTimeline({
      ...
      return this.allowFlatten && this.animation.effect?.updateTiming({
        easing: `linear`
      }), this.animation.onfinish = null, e && ur() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), n && (this.animation.rangeEnd = n), ue) : r(this);
    }
  },
  yr = {
    anticipate: we,
...
var Sr = 10,
  Cr = class extends vr {
    constructor(e) {
      xr(e), On(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
    }
    updateMotionValue(e) {
      let {
        motionValue: t,
      ...
      let o = new jn({
        ...
        s = Math.max(Sr, k.now() - this.startTime),
        c = ie(0, Sr, s - Sr),
        l = o.sample(s).value,
        {
          name: u
  ...
  wr = (e, t) => t === `zIndex` ? !1 : !!(typeof e == `number` || Array.isArray(e) || typeof e == `string` && (Ft.test(e) || e === `0`) && !e.startsWith(`url(`));
function Tr(e) {
  let t = e[0];
...
function Er(e, t, n, r) {
  ...
  let a = e[e.length - 1],
    o = wr(i, t),
    s = wr(a, t);
  return `${t}${i}${a}${o ? a : i}`, !o || !s ? !1 : Tr(e) || (n === `spring` || gr(n)) && r;
}
function Dr(e) {
...
var jr = new Set([`color`, `backgroundColor`, `outlineColor`, `fill`, `stroke`, `borderColor`, `borderTopColor`, `borderRightColor`, `borderBottomColor`, `borderLeftColor`]),
  Mr = le(() => Object.hasOwnProperty.call(Element.prototype, `animate`));
function Nr(e) {
  let {
    motionValue: t,
    name: n,
  ...
  return Mr() && n && (Or.has(n) || jr.has(n) && Ar(s)) && (n !== `transform` || !l) && !c && !r && i !== `mirror` && a !== 0 && o !== `inertia`;
}
var Pr = 40,
  Fr = class extends kn {
    constructor({
    ...
    onKeyframesResolved(e, t, n, r) {
      ...
      let u = !0;
      Er(e, i, a, o) || (u = !1, (ae.instantAnimations || !s) && l?.(En(e, n, t)), e[0] = e[e.length - 1], Dr(n), n.repeat = 0);
      let d = {
      ...
      m.finished.then(() => {
        this.notifyFinished();
      }).catch(ue), this.pendingTimeline &&= (this.stopTimeline = m.attachTimeline(this.pendingTimeline), void 0), this._animation = m;
    }
    get finished() {
...
var Lr = 30,
  ...
  Br = class {
    ...
    setCurrent(e) {
      this.current = e, this.updatedAt = k.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Rr(this.current));
    }
...
var Wr = {
  ...
  Jr = (e, {
    keyframes: t
  }) => t.length > 2 ? Kr : Kn.has(e) ? e.startsWith(`scale`) ? Gr(t[1]) : Wr : qr,
  Yr = new Set([`when`, `delay`, `delayChildren`, `staggerChildren`, `staggerDirection`, `repeat`, `repeatType`, `repeatDelay`, `from`, `elapsed`]);
function Xr(e) {
...
var Zr = (e, t, n, r = {}, i, a) => o => {
    ...
    Xr(s) || Object.assign(u, Jr(e, u)), u.duration &&= fe(u.duration), u.repeatDelay &&= fe(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
    let d = !1;
    if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (Dr(u), u.delay === 0 && (d = !0)), (ae.instantAnimations || ae.skipAnimations || i?.shouldSkipAnimations || s.skipAnimations) && (d = !0, Dr(u), u.delay = 0), u.allowFlatten = !s.type && !s.ease, d && !a && t.get() !== void 0) {
    ...
    return s.isSync ? new jn(u) : new Fr(u);
  },
...
function ri(e, t, n) {
  let r = e.getProps();
  return ni(r, t, n === void 0 ? r.custom : n, e);
}
var ii = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...Gn]),
...
function _i(e, t, n = {}) {
  let r = ri(e, t, n.type === `exit` ? e.presenceContext?.custom : void 0),
    {
...
function vi(e, t, n = 0, r = 0, i = 0, a = 1, o) {
  let s = [];
  for (let c of e.variantChildren) c.notify(`AnimationStart`, t), s.push(_i(c, t, {
    ...o,
    delay: n + (typeof r == `function` ? 0 : r) + Ir(e.variantChildren, c, r, i, a)
...
function yi(e, t, n = {}) {
  ...
  if (Array.isArray(t)) {
    ...
    r = Promise.all(i);
  } else if (typeof t == `string`) r = _i(e, t, n);else {
    let i = typeof t == `function` ? ri(e, t, n.custom) : t;
...
var bi = {
  ...
  xi = e => t => t.test(e),
  Si = [$e, j, A, mt, gt, ht, bi],
  Ci = e => Si.find(xi(e));
function wi(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || ce(e);
}
...
function Fi(e, t) {
  let n = Ni(e);
  return Pi.has(n) || (n = Ft), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
...
function Li(e, t, n) {
  ...
  for (; r < e.length && !i;) {
    let t = e[r];
    typeof t == `string` && !Ii.has(t) && Ot(t).values.length && (i = e[r]), r++;
  }
  if (i && n) for (let r of t) e[r] = Fi(n, i);
}
var Ri = class extends ar {
  ...
  readKeyframes() {
    ...
    if (this.resolveNoneKeyframes(), !ii.has(n) || e.length !== 2) return;
    let [r, i] = e,
      a = Ci(r),
      o = Ci(i);
    if (Qe(r) !== Qe(i) && Zn[n]) {
    ...
    if (a !== o) if (qn(a) && qn(o)) for (let t = 0; t < e.length; t++) {
      let n = e[t];
      typeof n == `string` && (e[t] = parseFloat(n));
    } else Zn[n] && (this.needsMeasurement = !0);
  }
  ...
  measureInitialState() {
    ...
    n === `height` && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = Zn[n](e.measureViewportBox(), window.getComputedStyle(e.current)), t[0] = this.measuredOrigin;
    let r = t[t.length - 1];
  ...
  measureEndState() {
    ...
    let i = n.length - 1,
      a = n[i];
    n[i] = Zn[t](e.measureViewportBox(), window.getComputedStyle(e.current)), a !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = a), this.removedTransforms?.length && this.removedTransforms.forEach(([t, n]) => {
      e.getValue(t).set(n);
...
var F = (e, t) => t && typeof e == `number` ? t.transform(e) : e;
function zi(e) {
...
function Wi(e) {
  return e === `x` || e === `y` ? Hi[e] ? null : (Hi[e] = !0, () => {
    Hi[e] = !1;
  }) : Hi.x || Hi.y ? null : (Hi.x = Hi.y = !0, () => {
    Hi.x = Hi.y = !1;
  });
}
function Gi(e, t) {
...
function oa(e, t, n = {}) {
  let [r, i, a] = Gi(e, n),
    o = e => {
      ...
      let a = t(r, e),
        o = (e, t) => {
          window.removeEventListener(`pointerup`, s), window.removeEventListener(`pointercancel`, c), ea.has(r) && ea.delete(r), ia(e) && typeof a == `function` && a(e, {
            success: t
          });
        },
        s = e => {
  ...
  return r.forEach(e => {
    (n.useGlobalTarget ? window : e).addEventListener(`pointerdown`, o, i), zi(e) && (e.addEventListener(`focus`, e => ra(e, i)), !Zi(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0));
  }), a;
}
function sa(e) {
...
var ca = new WeakMap(),
  la,
  ua = (e, t, n) => (r, i) => i && i[0] ? i[0][e + `Size`] : sa(r) && `getBBox` in r ? r.getBBox()[t] : r[n],
  da = ua(`inline`, `width`, `offsetWidth`),
  fa = ua(`block`, `height`, `offsetHeight`);
function pa({
  target: e,
  borderBoxSize: t
}) {
...
function ga(e, t) {
  ...
  return n.forEach(e => {
    let n = ca.get(e);
    n || (n = new Set(), ca.set(e, n)), n.add(t), la?.observe(e);
  }), () => {
    n.forEach(e => {
      let n = ca.get(e);
...
var ja = [`animate`, `whileInView`, `whileFocus`, `whileHover`, `whileTap`, `whileDrag`, `exit`],
  Ma = [`initial`, ...ja];
function Na(e) {
...
function Fa(e, t, n) {
  for (let r in t) {
    let i = t[r],
      a = n[r];
    if (li(i)) e.addValue(r, i);else if (li(a)) e.addValue(r, Vr(i, {
      owner: e
...
var Ba = [`AnimationStart`, `AnimationComplete`, `Update`, `BeforeLayoutMeasure`, `LayoutMeasure`, `LayoutAnimationStart`, `LayoutAnimationComplete`],
  Va = {};
function Ha(e) {
  Va = e;
}
...
var Wa = class {
    ...
    constructor({
      ...
      this.latestValues = c, this.baseTarget = {
        ...
        ...c
      } : {}, this.renderState = l, this.parent = e, this.props = t, this.presenceContext = n, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = r, this.skipAnimationsConfig = i, this.options = s, this.blockInitialAnimation = !!a, this.isControllingVariants = Na(t), this.isVariantNode = Pa(t), this.isVariantNode && (this.variantChildren = new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
      let {
        willChange: u,
        ...d
    ...
    readValue(e, t) {
      ...
      return n != null && (typeof n == `string` && (oe(n) || ce(n)) ? n = parseFloat(n) : !wa(n) && Ft.test(t) && (n = Fi(e, t)), this.setBaseTarget(e, li(n) ? n.get() : n)), li(n) ? n.get() : n;
    }
    setBaseTarget(e, t) {
      this.baseTarget[e] = t;
    }
    getBaseTarget(e) {
      ...
      if (typeof t == `string` || typeof t == `object`) {
        let r = ni(this.props, t, this.presenceContext?.custom);
        r && (n = r[e]);
      }
      if (t && n !== void 0) return n;
      let r = this.getBaseTargetFromProps(this.props, e);
      return r !== void 0 && !li(r) ? r : this.initialValues[e] !== void 0 && n === void 0 ? void 0 : this.baseTarget[e];
    }
    on(e, t) {
  ...
  Ga = class extends Wa {
    ...
    handleChildMotionValue() {
      ...
      li(e) && (this.childSubscription = e.on(`change`, e => {
...
function so(e, t, n, r = !1) {
  ...
  for (let s = 0; s < i; s++) {
    ...
    i && i.props.style && i.props.style.display === `contents` || (r && a.options.layoutScroll && a.scroll && a !== a.root && (co(e.x, -a.scroll.offset.x), co(e.y, -a.scroll.offset.y)), o && (t.x *= o.x.scale, t.y *= o.y.scale, io(e, o)), r && Qa(a.latestValues) && fo(e, a.latestValues, a.layout?.layoutBox));
  }
...
function lo(e, t, n, r, i = .5) {
  ro(e, t, n, M(e.min, e.max, i), r);
}
function uo(e, t) {
...
function fo(e, t, n) {
  let r = n ?? e;
  lo(e.x, uo(t.x, r.x), t.scaleX, t.scale, t.originX), lo(e.y, uo(t.y, r.y), t.scaleY, t.scale, t.originY);
}
function po(e, t) {
...
function R(e, t, n) {
  ...
  for (let a = 0; a < ho; a++) {
    ...
    let c = !0;
    if (typeof s == `number`) c = s === +!!o.startsWith(`scale`);else {
      let e = parseFloat(s);
  ...
  return a && (i = !1, r += `rotate(${F(a, ji.pathRotation)}) `), r = r.trim(), n ? r = n(t, i ? `` : r) : i && (r = `none`), r;
}
function z(e, t, n) {
  let {
      style: r,
  ...
  if (t.transform || (o || n ? r.transform = R(t, e.transform, n) : r.transform &&= `none`), s) {
    let {
      originX: e = `50%`,
      originY: t = `50%`,
      originZ: n = 0
...
function xo(e, {
  ...
  return Kn.has(e) || e.startsWith(`origin`) || (t || n !== void 0) && (!!bo[e] || e === `opacity`);
}
function So(e, t, n) {
  let r = e.style,
    i = t?.style,
    a = {};
  if (!r) return a;
  for (let t in r) (li(r[t]) || i && li(i[t]) || xo(t, e) || n?.getValue(t)?.liveStyle !== void 0) && (a[t] = r[t]);
  return a;
}
function Co(e) {
  return window.getComputedStyle(e);
}
var B = class extends Ga {
    constructor() {
      super(...arguments), this.type = `html`, this.renderInstance = go;
    }
    readValueFromInstance(e, t) {
      if (Kn.has(t)) return this.projection?.isProjecting ? Vn(t) : Un(e, t);
      {
        let n = Co(e),
...
function Eo(e, t, n = 1, r = 0, i = !0) {
  e.pathLength = 1;
  let a = i ? wo : To;
  e[a.offset] = `${-r}`, e[a.array] = `${t} ${n}`;
}
var Do = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`];
function Oo(e, {
  attrX: t,
  attrY: n,
  attrScale: r,
  ...
  for (let e of Do) d[e] !== void 0 && (f[e] = d[e], delete d[e]);
  t !== void 0 && (d.x = t), n !== void 0 && (d.y = n), r !== void 0 && (d.scale = r), i !== void 0 && Eo(d, i, a, o, !1);
}
var ko = new Set([`baseFrequency`, `diffuseConstant`, `kernelMatrix`, `kernelUnitLength`, `keySplines`, `keyTimes`, `limitingConeAngle`, `markerHeight`, `markerWidth`, `numOctaves`, `targetX`, `targetY`, `surfaceScale`, `specularConstant`, `specularExponent`, `stdDeviation`, `tableValues`, `viewBox`, `gradientTransform`, `pathLength`, `startOffset`, `textLength`, `lengthAdjust`]),
  Ao = e => typeof e == `string` && e.toLowerCase() === `svg`;
function jo(e, t, n, r) {
  go(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(ko.has(n) ? n : fi(n), t.attrs[n]);
}
function Mo(e, t, n) {
  let r = So(e, t, n);
  for (let n in e) if (li(e[n]) || li(t[n])) {
    let t = Gn.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
    r[t] = e[n];
  }
  return r;
}
var No = class extends Ga {
    constructor() {
    ...
    readValueFromInstance(e, t) {
      ...
      return t = ko.has(t) ? t : fi(t), e.getAttribute(t);
    }
    scrapeMotionValuesFromProps(e, t, n) {
      return Mo(e, t, n);
    }
...
function Bo(e) {
  let t = zo(e),
    ...
    i = !1,
    a = t => (n, r) => {
      let i = ri(e, r, t === `exit` ? e.presenceContext?.custom : void 0);
      if (i) {
        let {
          transition: e,
          transitionEnd: t,
  ...
  function s(o) {
    ...
    for (let t = 0; t < Ro; t++) {
      ...
      if (v && (r || i) && e.manuallyAnimateOnMount && (v = !1), m.protectedKeys = {
        ...d
      }, !m.isActive && _ === null || !h && !m.prevProp || ka(h) || typeof h == `boolean`) continue;
      ...
      for (let e in ee) {
        ...
        let r = !1;
        r = ai(t) && ai(n) ? !Io(t, n) || y : t !== n, r ? t == null ? u.add(e) : te(e) : t !== void 0 && u.has(e) ? te(e) : m.protectedKeys[e] = !0;
      }
      ...
      b && (!ne || x) && l.push(...S.map(t => {
        ...
        if (typeof t == `string` && (r || i) && !ne && e.manuallyAnimateOnMount && e.parent) {
          ...
          if (r.enteringChildren && i) {
            ...
            n.delay = Ir(r.enteringChildren, e, t);
          }
        }
        return {
          animation: t,
    ...
    if (u.size) {
      ...
      if (typeof s.initial != `boolean`) {
        let n = ri(e, Array.isArray(s.initial) ? s.initial[0] : s.initial);
...
function Vo(e, t) {
  return typeof t == `string` ? t !== e : Array.isArray(t) ? !Io(t, e) : !1;
}
function Ho(e = !1) {
  return {
    isActive: e,
...
function $o(e, t, n, r = .5) {
  e.origin = r, e.originPoint = M(t.min, t.max, e.origin), e.scale = Zo(n) / Zo(t), e.translate = M(n.min, n.max, e.origin) - e.originPoint, (e.scale >= qo && e.scale <= Jo || isNaN(e.scale)) && (e.scale = 1), (e.translate >= Yo && e.translate <= Xo || isNaN(e.translate)) && (e.translate = 0);
}
function es(e, t, n, r) {
  $o(e.x, t.x, n.x, r ? r.originX : void 0), $o(e.y, t.y, n.y, r ? r.originY : void 0);
}
function ts(e, t, n, r = 0) {
  e.min = (r ? M(n.min, n.max, r) : n.min) + t.min, e.max = e.min + Zo(t);
}
function ns(e, t, n, r) {
...
function os(e, t = 0, n = 1, r = .5, i, a = e, o = e) {
  if (A.test(t) && (t = parseFloat(t), t = M(o.min, o.max, t / 100) - o.min), typeof t != `number`) return;
  let s = M(a.min, a.max, r);
  e === a && (s -= t), e.min = as(e.min, t, n, s, i), e.max = as(e.max, t, n, s, i);
}
...
var cs = [`x`, `scaleX`, `originX`],
  ls = [`y`, `scaleY`, `originY`];
function us(e, t, n, r) {
  ss(e.x, t, cs, n ? n.x : void 0, r ? r.x : void 0), ss(e.y, t, ls, n ? n.y : void 0, r ? r.y : void 0);
}
function ds(e) {
...
var xs = [`borderTopLeftRadius`, `borderTopRightRadius`, `borderBottomLeftRadius`, `borderBottomRightRadius`],
  Ss = xs.length,
  Cs = e => typeof e == `string` ? parseFloat(e) : e,
  ws = e => typeof e == `number` || j.test(e);
function Ts(e, t, n, r, i, a) {
  i ? (e.opacity = M(0, n.opacity ?? 1, Ds(r)), e.opacityExit = M(t.opacity ?? 1, 0, Os(r))) : a && (e.opacity = M(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let i = 0; i < Ss; i++) {
    let a = xs[i],
      o = Es(t, a),
      s = Es(n, a);
    o === void 0 && s === void 0 || (o ||= 0, s ||= 0, o === 0 || s === 0 || ws(o) === ws(s) ? (e[a] = Math.max(M(Cs(o), Cs(s), r), 0), (A.test(s) || A.test(o)) && (e[a] += `%`)) : e[a] = s);
  }
...
var Is = class {
    ...
    add(e) {
      ...
      for (let t = this.members.length - 1; t >= 0; t--) {
        ...
        let r = n.instance;
        (!r || r.isConnected === !1) && !n.snapshot && (re(this.members, n), n.unmount());
      }
      e.scheduleRender();
    }
    remove(e) {
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      this.id = Vs++, this.animationId = 0, this.animationCommitId = 0, this.children = new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
        ...
        this.projectionUpdateScheduled = !1, Le.value && (Rs.nodes = Rs.calculatedTargetDeltas = Rs.calculatedProjections = 0), this.nodes.forEach(qs), this.nodes.forEach(nc), this.nodes.forEach(rc), this.nodes.forEach(Js), Le.addProjectionMetrics && Le.addProjectionMetrics(Rs);
    ...
    addEventListener(e, t) {
      return this.eventHandlers.has(e) || this.eventHandlers.set(e, new de()), this.eventHandlers.get(e).add(t);
    }
    notifyListeners(e, ...t) {
    ...
    mount(t) {
      ...
      n && this.root.registerSharedNode(n, this), this.options.animate !== !1 && i && (n || r) && this.addEventListener(`didUpdate`, ({
        ...
        let a = this.options.transition || i.getDefaultTransition() || uc,
          {
    ...
    unmount() {
      ...
      let e = this.getStack();
      e && e.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, this.eventHandlers.clear(), Ve(this.updateProjection);
    }
    blockUpdate() {
    ...
    update() {
      ...
      let e = k.now();
      He.delta = ie(0, 1e3 / 60, e - He.timestamp), He.timestamp = e, He.isProcessing = !0, Ue.update.process(He), Ue.preRender.process(He), Ue.render.process(He), He.isProcessing = !1;
    }
    didUpdate() {
    ...
    updateLayout() {
      ...
      let e = this.layout;
      this.layout = this.measure(!1), this.layoutVersion++, this.layoutCorrected ||= I(), this.isLayoutDirty = !1, this.projectionDelta = void 0, this.notifyListeners(`measure`, this.layout.layoutBox);
      let {
        visualElement: t
      } = this.options;
    ...
    removeElementScroll(e) {
      let t = I();
      if (Go(t, e), this.scroll?.wasRoot) return t;
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root && i && a.layoutScroll && (i.wasRoot && Go(t, e), co(t.x, i.offset.x), co(t.y, i.offset.y));
      }
      return t;
    }
    applyTransform(e, t = !1, n) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        !t && n.options.layoutScroll && n.scroll && n !== n.root && (co(r.x, -n.scroll.offset.x), co(r.y, -n.scroll.offset.y)), Qa(n.latestValues) && fo(r, n.latestValues, n.layout?.layoutBox);
      }
      return Qa(this.latestValues) && fo(r, this.latestValues, this.layout?.layoutBox), r;
    }
    removeTransform(e) {
      let t = I();
      Go(t, e);
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        n.instance && (Za(n.latestValues) && n.updateSnapshot(), r = I(), Go(r, n.measurePageBox())), us(t, n.latestValues, n.snapshot?.layoutBox, r);
      }
    ...
    resolveTargetDelta(e = !1) {
      ...
      a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && a && a.layout ? this.createRelativeTarget(a, this.layout.layoutBox, a.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = I(), this.targetWithTransforms = I()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), ns(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Go(this.target, this.layout.layoutBox), io(this.target, this.targetDelta)) : Go(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && a && !!a.resumingFrom == !!this.resumingFrom && !a.options.layoutScroll && a.target && this.animationProgress !== 1 ? this.createRelativeTarget(a, this.target, a.target) : this.relativeParent = this.relativeTarget = void 0), Le.value && Rs.calculatedTargetDeltas++);
    }
    ...
    createRelativeTarget(e, t, n) {
      this.relativeParent = e, this.linkedParentVersion = e.layoutVersion, this.forceRelativeParentToResolveTarget(), this.relativeTarget = I(), this.relativeTargetOrigin = I(), is(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0), Go(this.relativeTarget, this.relativeTargetOrigin);
    }
    ...
    calcProjection() {
      let e = this.getLead(),
        ...
        n = !0;
      if ((this.isProjectionDirty || this.parent?.isProjectionDirty) && (n = !1), t && (this.isSharedProjectionDirty || this.isTransformDirty) && (n = !1), this.resolvedRelativeTargetAt === He.timestamp && (n = !1), n) return;
      let {
        layout: r,
        layoutId: i
      } = this.options;
      ...
      let a = this.treeScale.x,
        o = this.treeScale.y;
      so(this.layoutCorrected, this.treeScale, this.path, t), e.layout && !e.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (e.target = e.layout.layoutBox, e.targetWithTransforms = I());
      let {
        target: s
      } = e;
      if (!s) {
    ...
    setAnimationOrigin(e, t = !1, n) {
      ...
      let s = I(),
        ...
        d = !!(c && !u && this.options.crossfade === !0 && !this.path.some(lc));
      ...
      this.mixTargetDelta = t => {
        let n = t / 1e3,
          r = p?.(n);
        r ? (o.x.translate = r.x, o.x.scale = M(e.x.scale, 1, n), o.x.origin = e.x.origin, o.x.originPoint = e.x.originPoint, o.y.translate = r.y, o.y.scale = M(e.y.scale, 1, n), o.y.origin = e.y.origin, o.y.originPoint = e.y.originPoint) : (oc(o.x, e.x, n), oc(o.y, e.y, n)), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (is(s, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0), cc(this.relativeTarget, this.relativeTargetOrigin, s, n), f && ms(this.relativeTarget, f) && (this.isProjectionDirty = !1), f ||= I(), Go(f, this.relativeTarget)), c && (this.animationValues = a, Ts(a, i, this.latestValues, n, d, u)), r && r.rotate !== void 0 && (this.animationValues ||= a, this.animationValues.pathRotation = r.rotate), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = n;
      }, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0);
    }
    startAnimation(e) {
      this.notifyListeners(`animationStart`), this.currentAnimation?.stop(), this.resumingFrom?.currentAnimation?.stop(), this.pendingAnimation &&= (Ve(this.pendingAnimation), void 0), this.pendingAnimation = O.update(() => {
        Ls.hasAnimatedSinceResize = !0, Ke.layout++, this.motionValue ||= Vr(0), this.motionValue.jump(0, !1), this.currentAnimation = As(this.motionValue, [0, 1e3], {
          ...e,
          velocity: 0,
          isSync: !0,
          onUpdate: t => {
          ...
          onComplete: () => {
            Ke.layout--, e.onComplete && e.onComplete(), this.completeAnimation();
          }
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        Go(t, n), fo(t, i), es(this.projectionDeltaWithTransform, this.layoutCorrected, t, i);
      }
    }
    ...
    applyProjectionStyles(e, t) {
      ...
      if (!this.projectionDelta || !this.layout || !r.target) {
        this.options.layoutId && (e.opacity = this.latestValues.opacity === void 0 ? 1 : this.latestValues.opacity, e.pointerEvents = Fs(t?.pointerEvents) || ``), this.hasProjected && !Qa(this.latestValues) && (e.transform = n ? n({}, ``) : `none`, this.hasProjected = !1);
        return;
      }
      e.visibility = ``;
...
function Ks(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
    ...
    if (i === `size`) ys(e => {
      ...
      let e = i === `x` ? `y` : `x`;
      Wo(a ? t.measuredBox[e] : t.layoutBox[e], n[e]);
    } else hc(i, t.layoutBox, n) && ys(r => {
    ...
    if (!e.resumeFrom) {
      ...
      if (r && !r.resumeFrom) {
        ...
        if (i && a) {
          ...
          let c = I();
          is(c, n, a.layoutBox, o), gs(s, c) || (l = !0), r.options.layoutRoot && (e.relativeTarget = c, e.relativeTargetOrigin = s, e.relativeParent = r);
        }
      }
    }
...
function qs(e) {
  Le.value && Rs.nodes++, e.parent && (e.isProjecting() || (e.isProjectionDirty = e.parent.isProjectionDirty), e.isSharedProjectionDirty ||= !!(e.isProjectionDirty || e.parent.isProjectionDirty || e.parent.isSharedProjectionDirty), e.isTransformDirty ||= e.parent.isTransformDirty);
}
function Js(e) {
...
function oc(e, t, n) {
  e.translate = M(t.translate, 0, n), e.scale = M(t.scale, 1, n), e.origin = t.origin, e.originPoint = t.originPoint;
}
function sc(e, t, n, r) {
...
var uc = {
  ...
  dc = e => typeof navigator < `u` && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e),
  fc = dc(`applewebkit/`) && !dc(`chrome/`) ? Math.round : ue;
function pc(e) {
...
function hc(e, t, n) {
  return e === `position` || e === `preserve-aspect` && !Qo(_s(t), _s(n), .2);
}
function gc(e) {
...
function Cc(...e) {
  return S.useCallback(Sc(...e), e);
}
var V = x(),
  wc = class extends S.Component {
    getSnapshotBeforeUpdate(e) {
      let t = this.props.childRef.current;
      if (zi(t) && e.isPresent && !this.props.isPresent && this.props.pop !== !1) {
...
function Tc({
  ...
  return (0, S.useInsertionEffect)(() => {
    ...
    sizeRef: c,
    pop: a,
    children: a === !1 ? e : S.cloneElement(e, {
      ref: u
    })
  });
}
...
var jc = ({
    ...
    if (f !== v) {
      ...
      return a === `wait` && te.length && (e = te), x(Ac(e)), y(f), null;
    }
    let {
      forceRender: ne
    } = (0, S.useContext)(C);
      ...
      children: b.map(e => {
        ...
        return (0, V.jsx)(Ec, {
          ...
          onExitComplete: y ? void 0 : () => {
            ...
            if (g.has(v)) _.current.add(v), g.set(v, !0);else return;
            let e = !0;
            g.forEach(t => {
              t || (e = !1);
...
var Rc = new Set(`animate.exit.variants.initial.style.values.variants.transition.transformTemplate.custom.inherit.onBeforeLayoutMeasure.onAnimationStart.onAnimationComplete.onUpdate.onDragStart.onDrag.onDragEnd.onMeasureDragConstraints.onDirectionLock.onDragTransitionEnd._dragX._dragY.onHoverStart.onHoverEnd.onViewportEnter.onViewportLeave.globalTapTarget.propagate.ignoreStrict.viewport`.split(`.`));
function zc(e) {
  return e.startsWith(`while`) || e.startsWith(`drag`) && e !== `draggable` || e.startsWith(`layout`) || e.startsWith(`onTap`) || e.startsWith(`onPan`) || e.startsWith(`onLayout`) || Rc.has(e);
}
var H = c({
    default: () => Bc
  }),
  Bc,
  Vc = o(() => {
    throw Bc = {}, Error(`Could not resolve "@emotion/is-prop-valid" imported by "framer-motion". Is it installed?`);
  }),
  Hc = e => !zc(e);
function Uc(e) {
...
function Wc(e, t, n) {
  let r = {};
  for (let i in e) i === `values` && typeof e.values == `object` || li(e[i]) || (Hc(i) || n === !0 && zc(i) || !t && !zc(i) || e.draggable && i.startsWith(`onDrag`)) && (r[i] = e[i]);
  return r;
}
var Gc = (0, S.createContext)({});
function Kc(e, t) {
  if (Na(e)) {
    let {
      initial: t,
...
function Xc(e, t, n) {
  for (let r in t) !li(t[r]) && !xo(r, n) && (e[r] = t[r]);
}
function Zc({
  transformTemplate: e
}, t) {
...
function tl(e, t, n, r) {
  let i = (0, S.useMemo)(() => {
    let n = el();
    return Oo(n, t, Ao(r), e.transformTemplate, e.style), {
      ...n.attrs,
      style: {
        ...n.style
      }
...
var nl = [`animate`, `circle`, `defs`, `desc`, `ellipse`, `g`, `image`, `line`, `filter`, `marker`, `mask`, `metadata`, `path`, `pattern`, `polygon`, `polyline`, `rect`, `stop`, `switch`, `symbol`, `svg`, `text`, `tspan`, `use`, `view`];
function U(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(nl.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function rl(e, t, n, {
  latestValues: r
}, i, a = !1, o) {
...
function fl(e, t, n, r, i, a) {
  ...
  let m = f.current,
    h = (0, S.useContext)(ul);
  m && !m.projection && i && (m.type === `html` || m.type === `svg`) && pl(f.current, n, i, h);
  let g = (0, S.useRef)(!1);
  (0, S.useInsertionEffect)(() => {
    m && g.current && m.update(n, c);
  });
  let _ = n[pi],
    v = (0, S.useRef)(!!_ && typeof window < `u` && !window.MotionHandoffIsComplete?.(_) && window.MotionHasOptimisedAnimation?.(_));
  return ee(() => {
...
function hl(e, {
  ...
  function s(n, s) {
    ...
    if (!u && typeof window < `u`) {
      _l(l, r);
      let t = vl(l);
      c = t.MeasureLayout, d.visualElement = fl(e, f, l, i, t.ProjectionNode, a);
    }
    return (0, V.jsxs)(Gc.Provider, {
      value: d,
      children: [c && d.visualElement ? (0, V.jsx)(c, {
        visualElement: d.visualElement,
        ...l
      }) : null, rl(e, n, ll(f, d.visualElement, s), f, u, t, a)]
    });
  }
...
function yl(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => a === `create` ? r : (n.has(a) || n.set(a, hl(a, void 0, e, t)), n.get(a))
  });
}
var bl = (e, t) => t.isSVG ?? U(e) ? new No(t) : new B(t, {
...
var Tl = e => t => Yi(t) && e(t, wl(t));
function El(e, t, n, r) {
  return js(e, t, Tl(n), r);
}
var Dl = ({
    current: e
  ...
  jl = class {
    constructor(e, t, {
      ...
      if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.lastRawMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.scrollPositions = new Map(), this.removeScrollListeners = null, this.onElementScroll = e => {
        ...
        this.lastMoveEvent = e, this.lastRawMoveEventInfo = t, this.lastMoveEventInfo = Ml(t, this.transformPagePoint), O.update(this.updatePoint, !0);
        ...
        let a = Pl(e.type === `pointercancel` ? this.lastMoveEventInfo : Ml(t, this.transformPagePoint), this.history);
      ...
      u && u(e, Pl(s, this.history)), this.removeListeners = T(El(this.contextWindow, `pointermove`, this.handlePointerMove), El(this.contextWindow, `pointerup`, this.handlePointerUp), El(this.contextWindow, `pointercancel`, this.handlePointerUp)), o && this.startScrollTracking(o);
    }
    startScrollTracking(e) {
      let t = e.parentElement;
      for (; t;) {
        let e = getComputedStyle(t);
        (Al.has(e.overflowX) || Al.has(e.overflowY)) && this.scrollPositions.set(t, {
          x: t.scrollLeft,
          y: t.scrollTop
        }), t = t.parentElement;
      }
...
function Ll(e, t) {
  ...
  let n = e.length - 1,
    r = null,
    i = Il(e);
  for (; n >= 0 && (r = e[n], !(i.timestamp - r.timestamp > fe(t)));) n--;
  if (!r) return {
    x: 0,
    y: 0
  };
  r === e[0] && e.length > 2 && i.timestamp - r.timestamp > fe(t) * 2 && (r = e[1]);
  let a = pe(i.timestamp - r.timestamp);
  if (a === 0) return {
    x: 0,
    y: 0
  };
...
function J(e, t) {
  let n = .5,
    r = Zo(e),
    i = Zo(t);
  return i > r ? n = E(t.min, t.max - r, e.min) : r > i && (n = E(e.min, e.max - i, t.min)), ie(0, 1, n);
}
function Y(e, t) {
  let n = {};
  ...
  X = class {
    constructor(e) {
      this.openDragLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
        x: 0,
        y: 0
      }, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = I(), this.latestPointerEvent = null, this.latestPanInfo = null, this.visualElement = e;
    }
    start(e, {
      snapToCursor: t = !1,
      distanceThreshold: n
      ...
      let i = e => {
        ...
        a = (e, t) => {
          ...
          this.latestPointerEvent = e, this.latestPanInfo = t, this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), ys(e => {
          ...
          }), i && O.update(() => i(e, t), !1, !0), di(this.visualElement, `transform`);
          let {
            animationState: a
          } = this.visualElement;
    ...
    resolveConstraints() {
      let {
        ...
        r = this.constraints;
      e && dl(e) ? this.constraints ||= this.resolveRefConstraints() : e && n ? this.constraints = G(n.layoutBox, e) : this.constraints = !1, this.elastic = Vl(t), r !== this.constraints && !dl(e) && n && this.constraints && !this.hasMutatedConstraints && ys(e => {
    ...
    startAxisValueAnimation(e, t) {
      ...
      return di(this.visualElement, e), n.start(Zr(e, n, 0, t, this.visualElement, !1));
    }
    stopAnimation() {
    ...
    scalePositionWithinConstraints() {
      ...
      this.visualElement.current.style.transform = i ? i({}, ``) : `none`, n.root && n.root.updateScroll(), n.updateLayout(), this.constraints = !1, this.resolveConstraints(), ys(t => {
    ...
    addListeners() {
      ...
      let e = this.visualElement.current,
        ...
        r = () => {
          ...
          dl(t) && t.current && (this.constraints = this.resolveRefConstraints(), n ||= Kl(e, t.current, () => this.scalePositionWithinConstraints()));
        },
        {
          projection: i
        } = this.visualElement,
      ...
      let o = js(window, `resize`, () => this.scalePositionWithinConstraints()),
...
var Yl = class extends Ka {
    constructor(e) {
      super(e), this.removeGroupControls = ue, this.removeListeners = ue, this.controls = new X(e);
    }
    mount() {
      let {
        dragControls: e
      } = this.node.getProps();
      e && (this.removeGroupControls = e.subscribe(this.controls)), this.removeListeners = this.controls.addListeners() || ue;
    }
    update() {
      let {
          dragControls: e
  ...
  Zl = class extends Ka {
    ...
    mount() {
      this.removePointerDownListener = El(this.node.current, `pointerdown`, e => this.onPointerDown(e));
    }
    update() {
  ...
  $l = class extends S.Component {
    ...
    getSnapshotBeforeUpdate(e) {
      ...
      return a ? (a.isPresent = i, e.layoutDependency !== t && a.setOptions({
        ...a.options,
        layoutDependency: t
      }), Ql = !0, r || e.layoutDependency !== t || t === void 0 || e.isPresent !== i ? a.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? a.promote() : a.relegate() || O.postRender(() => {
        let e = a.getStack();
...
function eu(e) {
  ...
  return (0, V.jsx)($l, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: (0, S.useContext)(ul),
    isPresent: t,
    safeToRemove: n
  });
}
...
function nu(e, t, n) {
  ...
  let i = r[`onHover` + n];
  i && O.postRender(() => i(t, wl(t)));
}
var ru = class extends Ka {
    mount() {
      let {
        current: e
      } = this.node;
  ...
  iu = class extends Ka {
    ...
    mount() {
      this.unmount = T(js(this.node.current, `focus`, () => this.onFocus()), js(this.node.current, `blur`, () => this.onBlur()));
    }
    unmount() {}
  };
function au(e, t, n) {
...
var ou = class extends Ka {
    mount() {
      ...
      this.unmount = oa(e, (e, t) => (au(this.node, t, `Start`), (e, {
        success: t
      }) => au(this.node, e, t ? `End` : `Cancel`)), {
        useGlobalTarget: t,
...
var gu = {
  ...
  yu = (...e) => e.filter((e, t, n) => !!e && e.trim() !== `` && n.indexOf(e) === t).join(` `).trim(),
  bu = e => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  xu = e => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()),
  Su = e => {
    let t = xu(e);
  ...
  Eu = (e, t) => {
    let n = (0, S.forwardRef)(({
      className: n,
      ...r
    }, i) => (0, S.createElement)(Tu, {
      ref: i,
      iconNode: t,
      className: yu(`lucide-${bu(Su(e))}`, `lucide-${e}`, n),
      ...r
    }));
    return n.displayName = Su(e), n;
  },
  Du = Eu(`bell`, [[`path`, {
  ...
  Gu = S.createContext && S.createContext(Z),
  Ku = [`attr`, `size`, `title`];
function qu(e, t) {
  if (e == null) return {};
  var n,
...
function td(e) {
  return e && e.map((e, t) => S.createElement(e.tag, Zu({
    key: t
  }, e.attr), td(e.child)));
}
function nd(e) {
  return t => S.createElement(rd, Yu({
    attr: Zu({}, e.attr)
  }, t), td(e.child));
}
function rd(e) {
  var t = t => {
    var {
      ...
      o = r || t.size || `1em`,
      s;
    return t.className && (s = t.className), e.className && (s = (s ? s + ` ` : ``) + e.className), S.createElement(`svg`, Yu({
      stroke: `currentColor`,
      fill: `currentColor`,
      strokeWidth: `0`
    }, t.attr, n, a, {
      ...
      width: o,
      xmlns: `http://www.w3.org/2000/svg`
    }), i && S.createElement(`title`, null, i), e.children);
  };
  return Gu === void 0 ? t(Z) : S.createElement(Gu.Consumer, null, e => t(e));
}
var id = y();
function ad(e) {
  return nd({
...
function sd({
  ...
  return (0, V.jsxs)(`div`, {
    className: `relative rounded-2xl border border-white/10 bg-[#0e0e16]/95 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.7)] backdrop-blur ${r}`,
    children: [(0, V.jsxs)(`div`, {
      ...
      children: [(0, V.jsxs)(`div`, {
        ...
        className: `rounded-md border px-2 py-0.5 font-mono text-[10px] uppercase tracking-wider ${od[t.tone ?? `purple`]}`,
        children: t.label
      })]
    }), (0, V.jsx)(`div`, {
      className: `p-5`,
  ...
  return (0, V.jsxs)(vu.div, {
    ...
    children: [(0, V.jsx)(`svg`, {
      ...
      children: (0, V.jsx)(`path`, {
        d: `M3 2 L3 17 L7.5 13 L10 19 L13 17.8 L10.5 12 L17 12 Z`,
        fill: `white`,
        stroke: `black`,
        strokeWidth: `1`,
        strokeLinejoin: `round`
      ...
      className: `absolute -left-2 -top-2 h-6 w-6 rounded-full border border-violet-300`
    })]
  });
}
var ld = [{
    ...
    id: `4`,
    name: `Omega Transportes`,
    cnpj: `33.333.333/0001-33`,
    proc: `vence`,
    monitored: !1,
    selected: !1
  }],
  ud = [`Validando certificado…`, `Verificando validade até 14/08/2027…`, `Criptografando armazenamento…`],
  dd = [`Consultando procurações ativas…`, `Buscando empresas vinculadas…`, `Organizando CNPJs disponíveis…`];
function fd() {
  let [e, t] = (0, S.useState)(`empty`),
    [n, r] = (0, S.useState)(``),
    [i, a] = (0, S.useState)(0),
    [o, s] = (0, S.useState)(0),
    [c, l] = (0, S.useState)(ld),
  ...
  (0, S.useEffect)(() => {
    let e = !1,
      ...
      i = async e => {
        let t = f.current;
        if (!t) return;
        let r = t.querySelector(`[data-t="${e}"]`);
        if (!r) return;
        let i = t.getBoundingClientRect(),
          a = r.getBoundingClientRect();
        d(e => ({
          ...e,
          x: a.left - i.left + a.width / 2 - 6,
          y: a.top - i.top + a.height / 2 - 6,
          visible: !0,
          click: !1
        })), await n(560);
      },
    ...
    return (async () => {
      for (; !e;) {
        t(`empty`), r(``), a(0), s(0), l(ld), d({
          x: 30,
          y: 30,
          click: !1,
          visible: !1
        }), await n(700), await i(`upload`), await o(), t(`selecting`), await n(700), t(`password`), await i(`pwd`), await o();
        for (let t = 1; t <= 10; t++) {
          if (e) return;
          r(`••••••••••`.slice(0, t)), await n(70);
        }
        await n(300), await i(`save`), await o(), t(`validating`);
        for (let t = 0; t < ud.length; t++) {
          if (e) return;
          a(t), await n(700);
        }
        t(`validated`), await n(1400), await i(`sync`), await o(), t(`syncing`);
        ...
        for (let t of ld) {
          if (e) return;
          await i(`row-${t.id}`), await o(), l(e => e.map(e => e.id === t.id ? {
            ...e,
            selected: !0
          } : e)), await n(220);
        }
        t(`selected`), await n(600), await i(`activate`), await o(), t(`modal`), await n(1600), await i(`confirm`), await o(), l(e => e.map(e => ({
          ...e,
          monitored: !0
        }))), t(`success`), await n(3e3);
      }
    })(), () => {
      e = !0;
    };
  }, []);
  let p = c.filter(e => e.selected).length,
    m = [`list`, `selected`, `modal`, `success`].includes(e),
    h = e === `validated` || e === `syncing` || m;
  return (0, V.jsx)(sd, {
    title: `Configurar certificado · Juris8`,
    badge: {
      label: `1 vez`,
      tone: `blue`
    },
    children: (0, V.jsxs)(`div`, {
      ref: f,
      className: `relative grid grid-cols-[140px_1fr] gap-4`,
      children: [(0, V.jsx)(cd, {
        x: u.x,
        y: u.y,
        clicking: u.click,
        ...
        children: [(0, V.jsx)(`div`, {
          ...
          children: [{
            ...
            className: `flex items-center gap-2 rounded-md px-2 py-1.5 ${n ? `bg-violet-500/15 text-violet-200 ring-1 ring-violet-500/30` : `text-white/60 hover:bg-white/5`}`,
            children: [(0, V.jsx)(e, {
        ...
        className: `min-h-[520px] space-y-4`,
        children: [(0, V.jsxs)(`div`, {
          children: [(0, V.jsx)(`h2`, {
            className: `text-lg font-semibold text-white`,
            children: `Configure uma vez`
          }), (0, V.jsx)(`p`, {
            className: `text-xs text-white/55`,
            children: `Envie o certificado digital A1 e ative o monitoramento dos CNPJs com procuração ativa.`
          })]
        }), (0, V.jsxs)(`div`, {
          className: `grid grid-cols-2 gap-3`,
          children: [(0, V.jsxs)(`div`, {
            className: `rounded-xl border border-white/10 bg-gradient-to-b from-white/[0.04] to-transparent p-4`,
            children: [(0, V.jsxs)(`div`, {
              className: `mb-2 flex items-center justify-between`,
              children: [(0, V.jsx)(`span`, {
                className: `font-mono text-[10px] uppercase tracking-wider text-white/40`,
                children: `1 · Certificado A1`
              }), h && (0, V.jsxs)(`span`, {
                className: `flex items-center gap-1 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-1.5 py-0.5 text-[10px] text-emerald-300`,
                children: [(0, V.jsx)(Vu, {
                  className: `h-3 w-3`
                }), ` Ativo`]
              })]
              ...
              mode: `wait`,
              children: [e === `empty` && (0, V.jsxs)(vu.div, {
                "data-t": `upload`,
                initial: {
                  opacity: 0
                },
                ...
                className: `flex h-[160px] flex-col items-center justify-center rounded-lg border border-dashed border-white/15 bg-white/[0.02] px-4 text-center`,
                children: [(0, V.jsx)(Hu, {
                  className: `mb-2 h-5 w-5 text-white/40`
                }), (0, V.jsx)(`p`, {
                  className: `text-xs text-white/75`,
                  children: `Arraste seu certificado A1`
                }), (0, V.jsx)(`p`, {
                  className: `text-[10px] text-white/40`,
                  children: `ou clique para selecionar · .pfx / .p12`
                })]
              }, `empty`), (e === `selecting` || e === `password`) && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0,
                  y: 6
                },
                ...
                className: `space-y-2`,
                children: [(0, V.jsxs)(`div`, {
                  className: `flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-xs text-white/80`,
                  children: [(0, V.jsx)(ju, {
                    className: `h-4 w-4 text-violet-300`
                  }), (0, V.jsx)(`span`, {
                    className: `flex-1 truncate`,
                    children: `certificado_escritorio.pfx`
                  }), (0, V.jsx)(ku, {
                  ...
                  children: [(0, V.jsx)(`div`, {
                    className: `mb-1 text-[10px] uppercase tracking-wider text-white/40`,
                    children: `Senha do certificado`
                  }), (0, V.jsxs)(`div`, {
                    ...
                    children: [(0, V.jsx)(Fu, {
                      ...
                      className: `h-3.5 w-px bg-white/70`
                    })]
                  })]
                }), (0, V.jsx)(`button`, {
                  "data-t": `save`,
                  className: `w-full rounded-lg bg-violet-500/90 px-3 py-2 text-xs font-medium text-white shadow-[0_8px_20px_-8px_rgba(139,92,246,0.7)]`,
                  children: `Salvar com segurança`
                })]
              }, `pwd`), e === `validating` && (0, V.jsx)(vu.div, {
                initial: {
                  opacity: 0
                },
                animate: {
                ...
                children: ud.map((e, t) => (0, V.jsxs)(`div`, {
                  className: `flex items-center gap-2 text-xs`,
                  children: [t < i ? (0, V.jsx)(ku, {
                    className: `h-3.5 w-3.5 text-emerald-400`
                  }) : t === i ? (0, V.jsx)(Pu, {
                    ...
                    className: t <= i ? `text-white/85` : `text-white/30`,
                    children: e
                  })]
                }, e))
              }, `validating`), h && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0,
                  y: 6
                },
                ...
                children: [(0, V.jsxs)(`div`, {
                  ...
                  children: [(0, V.jsx)(ju, {
                    ...
                    children: [(0, V.jsx)(`div`, {
                      ...
                      children: `Validade · 14/08/2027`
                    })]
                  }), (0, V.jsx)(Vu, {
                    className: `h-4 w-4 text-emerald-400`
                  })]
                }), (0, V.jsxs)(`div`, {
                  className: `grid grid-cols-2 gap-2 text-[10px] text-white/55`,
                  children: [(0, V.jsx)(pd, {
                    k: `Proteção`,
                    v: `Criptografado`
                  }), (0, V.jsx)(pd, {
            ...
            children: [(0, V.jsxs)(`div`, {
              ...
              children: [(0, V.jsx)(`span`, {
                className: `font-mono text-[10px] uppercase tracking-wider text-white/40`,
                children: `2 · Sincronização`
              }), m && (0, V.jsx)(`span`, {
                className: `rounded-md border border-sky-500/30 bg-sky-500/10 px-1.5 py-0.5 text-[10px] text-sky-300`,
                children: `12 CNPJs`
              })]
            }), (0, V.jsxs)(jc, {
              mode: `wait`,
              children: [!h && e !== `validating` && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0
                },
                animate: {
                ...
                className: `flex h-[160px] flex-col items-center justify-center text-center`,
                children: [(0, V.jsx)(Fu, {
                  className: `mb-2 h-5 w-5 text-white/30`
                }), (0, V.jsx)(`p`, {
                  className: `text-[11px] text-white/40`,
                  children: `Envie o certificado para liberar`
                })]
              }, `locked`), e === `validating` && (0, V.jsx)(vu.div, {
                initial: {
                  opacity: 0
                },
                animate: {
                ...
                className: `flex h-[160px] items-center justify-center text-[11px] text-white/40`,
                children: `Aguardando validação…`
              }, `wait`), e === `validated` && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0,
                  y: 6
                },
                ...
                children: [(0, V.jsx)(`p`, {
                  ...
                  children: `Agora vamos buscar os CNPJs com procuração ativa vinculados ao escritório.`
                }), (0, V.jsxs)(`button`, {
                  "data-t": `sync`,
                  className: `flex w-full items-center justify-center gap-2 rounded-lg border border-sky-500/40 bg-sky-500/15 px-3 py-2 text-xs font-medium text-sky-100`,
                  children: [(0, V.jsx)(Ru, {
                    className: `h-3.5 w-3.5`
                  }), `Sincronizar CNPJs`]
                })]
              }, `ready-sync`), e === `syncing` && (0, V.jsx)(vu.div, {
                initial: {
                  opacity: 0
                },
                animate: {
                ...
                className: `space-y-2 py-2`,
                children: dd.map((e, t) => (0, V.jsxs)(`div`, {
                  className: `flex items-center gap-2 text-xs`,
                  children: [t < o ? (0, V.jsx)(ku, {
                    className: `h-3.5 w-3.5 text-emerald-400`
                  }) : t === o ? (0, V.jsx)(Pu, {
                    ...
                    className: t <= o ? `text-white/85` : `text-white/30`,
                    children: e
                  })]
                }, e))
              }, `syncing`), m && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0,
                  y: 6
                },
                ...
                children: [(0, V.jsxs)(`div`, {
                  ...
                  className: `text-[10px] text-white/40`,
                  children: `Última busca · hoje às 09:41`
                })]
              }, `found`)]
            })]
          })]
        }), (0, V.jsx)(jc, {
          children: m && (0, V.jsxs)(vu.div, {
            initial: {
              opacity: 0,
              y: 12
            },
            ...
            children: [(0, V.jsxs)(`div`, {
              ...
              children: [(0, V.jsx)(`span`, {
                className: `font-mono text-[10px] uppercase tracking-wider text-white/40`,
                children: `3 · CNPJs com procuração ativa`
              }), (0, V.jsxs)(`div`, {
                className: `flex items-center gap-1.5 rounded-md border border-white/10 bg-white/[0.04] px-2 py-1 text-[10px] text-white/45`,
                children: [(0, V.jsx)(zu, {
                  className: `h-3 w-3`
              ...
              children: c.map(e => (0, V.jsxs)(vu.div, {
                "data-t": `row-${e.id}`,
                layout: !0,
                className: `flex items-center gap-3 px-3 py-2 text-xs`,
                children: [(0, V.jsx)(vu.span, {
                  animate: {
                    backgroundColor: e.selected || e.monitored ? `#8b5cf6` : `rgba(255,255,255,0.04)`,
                    borderColor: e.selected || e.monitored ? `#8b5cf6` : `rgba(255,255,255,0.2)`
                  },
                  className: `flex h-4 w-4 items-center justify-center rounded border`,
                  children: (e.selected || e.monitored) && (0, V.jsx)(ku, {
                  ...
                  className: `hidden font-mono text-[10px] text-white/45 sm:inline`,
                  children: e.cnpj
                }), (0, V.jsx)(`span`, {
                  className: `rounded-md px-1.5 py-0.5 text-[10px] ${e.proc === `ativa` ? `bg-emerald-500/15 text-emerald-300` : `bg-amber-500/15 text-amber-300`}`,
                  children: e.proc === `ativa` ? `Procuração ativa` : `Vence em 18 dias`
                }), (0, V.jsx)(`span`, {
                  className: `w-20 text-right text-[10px] ${e.monitored ? `text-emerald-300` : `text-white/35`}`,
                  children: e.monitored ? `● Monitorando` : `○ Desligado`
                })]
              }, e.id))
            }), (0, V.jsx)(jc, {
              children: (e === `selected` || e === `modal`) && (0, V.jsxs)(vu.div, {
                initial: {
                  opacity: 0,
                  y: 8
                },
                ...
                className: `flex items-center justify-between border-t border-white/5 bg-violet-500/[0.08] px-3 py-2`,
                children: [(0, V.jsxs)(`span`, {
                  className: `text-[11px] text-violet-100`,
                  children: [p, ` CNPJs selecionados`]
                }), (0, V.jsx)(`button`, {
                  "data-t": `activate`,
                  className: `rounded-md bg-violet-500 px-3 py-1.5 text-[11px] font-medium text-white shadow-[0_6px_16px_-6px_rgba(139,92,246,0.8)]`,
                  children: `Ativar monitoramento`
                })]
              })
            })]
          }, `list`)
        }), (0, V.jsx)(jc, {
          children: e === `success` && (0, V.jsxs)(vu.div, {
            initial: {
              opacity: 0,
              y: 8
            },
            ...
            className: `flex items-center gap-3 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3`,
            children: [(0, V.jsx)(`div`, {
              ...
              className: `flex-1`,
              children: [(0, V.jsx)(`div`, {
                className: `text-xs font-medium text-emerald-100`,
                children: `Monitoramento ativado em 4 CNPJs`
              }), (0, V.jsx)(`div`, {
                className: `text-[10px] text-emerald-200/70`,
                children: `Novas comunicações chegarão na Caixa de Entrada Juris8.`
              })]
            }), (0, V.jsxs)(`button`, {
              className: `flex items-center gap-1.5 rounded-md bg-white/10 px-2.5 py-1 text-[11px] text-white`,
              children: [(0, V.jsx)(Mu, {
                className: `h-3 w-3`
              }), ` Caixa de entrada`]
            })]
        ...
        children: e === `modal` && (0, V.jsx)(vu.div, {
          initial: {
            opacity: 0
          },
          animate: {
          ...
          className: `absolute inset-0 z-40 flex items-center justify-center rounded-2xl bg-black/55 backdrop-blur-sm`,
          children: (0, V.jsxs)(vu.div, {
            initial: {
              scale: .94,
              opacity: 0
            },
            ...
            className: `w-[360px] rounded-xl border border-white/10 bg-[#13131c] p-4 shadow-2xl`,
            children: [(0, V.jsxs)(`div`, {
              className: `mb-3`,
              children: [(0, V.jsx)(`div`, {
                ...
                children: `Você está ativando o monitoramento para 4 CNPJs.`
              })]
            }), (0, V.jsxs)(`div`, {
              ...
              children: [(0, V.jsx)(`div`, {
                ...
                children: [{
                  ...
                  className: `flex items-center gap-1.5 rounded-md border border-white/10 bg-white/[0.04] px-2 py-1 text-white/80`,
                  children: [(0, V.jsx)(e, {
                    style: {
                      color: n
                    },
              ...
              children: [(0, V.jsx)(`button`, {
                className: `rounded-md border border-white/10 px-3 py-1.5 text-[11px] text-white/70`,
                children: `Cancelar`
              }), (0, V.jsx)(`button`, {
                "data-t": `confirm`,
                className: `rounded-md bg-violet-500 px-3 py-1.5 text-[11px] font-medium text-white`,
                children: `Confirmar ativação`
              })]
            })]
          })
        })
...
function md({
  ...
  return (0, V.jsxs)(`div`, {
    ...
    children: [(0, V.jsx)(`div`, {
      className: `text-base font-semibold ${n === `emerald` ? `text-emerald-300` : n === `amber` ? `text-amber-300` : `text-white`}`,
      children: t
    }), (0, V.jsx)(`div`, {
...
(0, id.createRoot)(document.getElementById(`root`)).render((0, V.jsx)(S.StrictMode, {
  children: (0, V.jsx)(gd, {})
}));
})(); } catch (e) { __ds_ns.__errors.push({ path: "site/mockup9-embed/dist/assets/index-D5YeOlk5.js", error: String((e && e.message) || e) }); }

// ui_kits/det-monitor/CertConfig.jsx
try { (() => {
// Juris8 app — certificate config + CNPJ selection (interactive).
const {
  useState: useCertState
} = React;
const INITIAL_CNPJS = [{
  id: '1',
  ...
  id: '2',
  name: 'Mercado Nobre SA',
  cnpj: '98.765.432/0001-11',
  proc: 'ativa'
}, {
  id: '3',
  name: 'Logística Ágil ME',
...
function CertConfig() {
  const {
    ...
    Badge,
    Stat
  } = window.Juris8DesignSystem_75d483;
  // stage: 'empty' | 'ready'
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Configure uma vez"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: 'var(--ink-400)',
      marginTop: 4
    }
  }, "Envie o certificado digital A1 e ative o monitoramento dos CNPJs com procura\xE7\xE3o ativa.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    style: cardLabel
  }, "1 \xB7 Certificado A1"), stage === 'ready' && /*#__PURE__*/React.createElement(Badge, {
    tone: "ok",
    dot: true
  }, "Ativo")), stage === 'empty' ? /*#__PURE__*/React.createElement("button", {
  ...
  }, "Arraste seu certificado A1"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10.5,
      color: 'var(--dim)'
    }
  }, "ou clique para selecionar \xB7 .pfx / .p12")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
  ...
  }, "certificado_escritorio.pfx"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: 'var(--muted)'
    }
  }, "Validade \xB7 14/08/2027")), /*#__PURE__*/React.createElement("i", {
  ...
  }, [['Proteção', 'Criptografado'], ['Uso', 'Procurações']].map(([k, v]) => /*#__PURE__*/React.createElement("div", {
    key: k,
    style: {
      display: 'flex',
      justifyContent: 'space-between',
    ...
    style: cardLabel
  }, "2 \xB7 Sincroniza\xE7\xE3o"), stage === 'ready' && /*#__PURE__*/React.createElement(Badge, {
    tone: "info"
  }, "12 CNPJs")), stage === 'empty' ? /*#__PURE__*/React.createElement("div", {
    style: {
      height: 150,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "Envie o certificado para liberar")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 12
    ...
    value: activated ? '12' : '8',
    label: "Ativos",
    tone: "ok"
  }), /*#__PURE__*/React.createElement(Stat, {
    value: activated ? '0' : '4',
    label: "Dispon\xEDveis",
    tone: "warn"
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
  ...
  }, "\xDAltima busca \xB7 hoje \xE0s 09:41")))), stage === 'ready' && /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 'var(--r-5)',
      border: '1px solid var(--hairline-strong)',
      background: 'rgba(255,255,255,0.02)',
    ...
    style: cardLabel
  }, "3 \xB7 CNPJs com procura\xE7\xE3o ativa")), INITIAL_CNPJS.map(c => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        borderRadius: 'var(--r-2)',
        padding: '4px 8px',
        color: c.proc === 'ativa' ? 'var(--ok)' : 'var(--warn)',
        background: c.proc === 'ativa' ? 'var(--fill-ok)' : 'var(--fill-warn)',
        border: `1px solid ${c.proc === 'ativa' ? 'var(--border-ok)' : 'var(--border-warn)'}`
      }
    }, c.proc === 'ativa' ? 'Procuração ativa' : 'Vence em 18d'));
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, activated ? 'Monitoramento ativo em 4 CNPJs' : `${selectedCount} CNPJ${selectedCount === 1 ? '' : 's'} selecionado${selectedCount === 1 ? '' : 's'}`), /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
    size: "sm",
    disabled: selectedCount === 0 || activated,
    onClick: () => setActivated(true),
    iconLeft: activated ? /*#__PURE__*/React.createElement("i", {
      "data-lucide": "check",
      style: {
        width: 14,
        height: 14
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/det-monitor/CertConfig.jsx", error: String((e && e.message) || e) }); }

// ui_kits/det-monitor/Dashboard.jsx
try { (() => {
...
function Dashboard() {
  ...
  const alerts = [{
    ...
    tone: 'warning',
    icon: 'bell',
    title: 'Mercado Nobre SA · CNPJ 98.765.432/0001-11',
    description: 'Solicitação de documentos · Seguro-desemprego contestado',
    time: '07:52',
    tag: 'Atenção',
    action: 'Analisar'
  }, {
    ...
    tone: 'ok',
    icon: 'check',
    title: 'Logística Ágil ME · CNPJ 55.123.456/0001-33',
    description: 'Comunicado informativo · Nenhuma ação necessária',
    time: 'ontem',
    tag: 'Resolvido'
  }];
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "Painel DET"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 26,
      fontWeight: 500,
  ...
  }, "Carteira de clientes"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13.5,
      color: 'var(--ink-400)',
      marginTop: 4
    }
  }, "Acompanhe todas as comunica\xE7\xF5es trabalhistas em um s\xF3 lugar.")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 10,
      textTransform: 'uppercase',
  ...
  }, "Hoje \xB7 09:41")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "Novos alertas \u2014 hoje"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1,
      height: 1,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "11 CNPJs sem alertas nos \xFAltimos 30 dias"), /*#__PURE__*/React.createElement("a", {
    href: "#",
    style: {
      color: 'var(--juris-300)',
      textDecoration: 'none'
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/det-monitor/Dashboard.jsx", error: String((e && e.message) || e) }); }

// ui_kits/det-monitor/Marketing.jsx
try { (() => {
...
function Marketing({
  ...
  const I = (n, w = 17) => /*#__PURE__*/React.createElement("i", {
    "data-lucide": n,
    style: {
      width: w,
      height: w
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "primary",
    size: "sm",
    iconLeft: I('arrow-right', 13),
    onClick: onEnter
  }, "Falar com um especialista")))), /*#__PURE__*/React.createElement("section", {
    className: "shell",
    style: {
    ...
    tone: "brand",
    dot: true
  }, "Domic\xEDlio Eletr\xF4nico Trabalhista \xB7 monitoramento ativo"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "Monitore o DET dos seus clientes. ", /*#__PURE__*/React.createElement("span", {
    className: "grad",
    style: {
      fontWeight: 700
    }
  }, "Gere receita recorrente todo m\xEAs.")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 16,
      color: 'var(--ink-300)',
      lineHeight: 1.7,
  ...
  }, "O DET j\xE1 est\xE1 ativo e gerando revelias e multas para quem n\xE3o monitora. Saia na frente, monitore o DET dos seus clientes e gere receita mensal recorrente."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: 'var(--ink-300)',
      lineHeight: 1.6,
  ...
  }, "O advogado que chega primeiro n\xE3o apaga inc\xEAndio. ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: 'var(--text)',
      fontWeight: 500
    }
  }, "Ele evita que o inc\xEAndio comece.")), /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
    size: "lg",
    onClick: onEnter,
    style: {
  ...
  }, "Quero vender o monitoramento DET"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 8,
  ...
  }, pills.map(p => /*#__PURE__*/React.createElement("span", {
    key: p.label,
    style: {
      display: 'inline-flex',
      alignItems: 'center',
  ...
  }, I(p.icon, 12), p.label)))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      borderRadius: 'var(--r-5)',
      overflow: 'hidden',
      boxShadow: '0 34px 80px -40px rgba(0,0,0,0.85), 0 0 0 1px rgba(124,58,237,0.05)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, "Painel DET"), /*#__PURE__*/React.createElement(Badge, {
    tone: "ok",
    dot: true,
    style: {
      marginLeft: 'auto'
    }
  }, "monitorando 14 CNPJs")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 18,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "Novos alertas \u2014 hoje"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontSize: 17,
      fontWeight: 600,
      marginTop: 6
    }
  }, "Carteira de clientes")), /*#__PURE__*/React.createElement(Badge, {
    tone: "brand"
  }, "Hoje")), /*#__PURE__*/React.createElement(Alert, {
    tone: "urgent",
    icon: I('triangle-alert'),
    title: "Construtech Ltda \xB7 12.345.678/0001-90",
    description: "Notifica\xE7\xE3o de fiscaliza\xE7\xE3o \xB7 Prazo: 10 dias \xFAteis",
    time: "08:14",
    tag: "Urgente",
    action: "Analisar"
    ...
    tone: "warning",
    icon: I('bell'),
    title: "Mercado Nobre SA \xB7 98.765.432/0001-11",
    description: "Solicita\xE7\xE3o de documentos",
    time: "07:52",
    tag: "Aten\xE7\xE3o",
    action: "Analisar"
  }), /*#__PURE__*/React.createElement(Alert, {
    tone: "ok",
    icon: I('check'),
    title: "Log\xEDstica \xC1gil ME \xB7 55.123.456/0001-33",
    description: "Comunicado informativo",
    time: "ontem",
    tag: "Resolvido"
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      borderRadius: 'var(--r-3)',
      color: '#FFD9DF',
      background: 'rgba(40,12,20,0.82)',
      border: '1px solid rgba(251,113,133,0.45)',
      backdropFilter: 'blur(10px)'
    }
  }, I('triangle-alert', 13), " Nova comunica\xE7\xE3o \xB7 agora")))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '16px 0',
      background: 'var(--surface-1)',
      borderTop: '1px solid var(--hairline)',
  ...
  }, ['Monitoramento diário do DET', 'Carteira multi-CNPJ', 'Alertas antes da urgência', 'Histórico e status', 'Produto recorrente', 'LGPD'].map((t, i) => /*#__PURE__*/React.createElement("span", {
    key: t,
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      ...
      textTransform: 'uppercase',
      letterSpacing: '0.1em',
      color: i % 3 === 0 ? 'var(--juris-300)' : 'var(--muted)',
      padding: '7px 14px',
      borderRadius: 'var(--r-2)',
      border: `1px solid ${i % 3 === 0 ? 'rgba(124,58,237,0.25)' : 'var(--hairline-strong)'}`,
      background: i % 3 === 0 ? 'var(--fill-brand-weak)' : 'var(--surface-2)'
    }
  }, t)))));
}
window.Marketing = Marketing;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/det-monitor/Marketing.jsx", error: String((e && e.message) || e) }); }

// ui_kits/det-monitor/Sidebar.jsx
try { (() => {
...
function Sidebar({
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        background: on ? 'var(--fill-brand-strong)' : 'transparent',
  ...
  }, "Dr. Marcos Silva"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 9,
      color: 'var(--dim)',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/det-monitor/Sidebar.jsx", error: String((e && e.message) || e) }); }

// ui_kits/det-monitor/Topbar.jsx
try { (() => {
...
function Topbar({
  ...
  }, "Juris8"), /*#__PURE__*/React.createElement("i", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Buscar empresa ou CNPJ\u2026")), /*#__PURE__*/React.createElement(Badge, {
    tone: "ok",
    dot: true
  }, "14 CNPJs ao vivo"), /*#__PURE__*/React.createElement("button", {
    style: {
      width: 36,
      height: 36,
      borderRadius: 'var(--r-3)',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/det-monitor/Topbar.jsx", error: String((e && e.message) || e) }); }
